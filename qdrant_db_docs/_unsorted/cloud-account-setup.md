---
title: Setting up a Qdrant Cloud Account
source: https://qdrant.tech/documentation/cloud-account-setup/
---
...
![Create Account](https://qdrant.tech/documentation/cloud/create-new-account.png)
...
To transfer ownership of an account, as the owner, visit the _Access Management_ page. In the actions menu of the user you wish to transfer to, you will find the option ‘Make Account Owner’ which begins the transfer.
...
Enterprise Sign-On is available as an add-on for [Premium Tier](https://qdrant.tech/documentation/cloud-premium/) ([local](./cloud-premium.md)) customers. If you are interested in using SSO, please [contact us](https://qdrant.tech/contact-us/).
