---
title: Migrate from Weaviate to Qdrant
source: https://qdrant.tech/documentation/migrate-to-qdrant/from-weaviate/
---
...
**Important:** Because Weaviate does not expose vector dimensions, the migration tool cannot auto-create the Qdrant collection. You must create the collection manually before running the migration.
