---
title: Migrate from MongoDB to Qdrant
source: https://qdrant.tech/documentation/migrate-to-qdrant/from-mongodb/
---
...
**Important:** MongoDB does not expose vector dimensions or distance metrics in a way the tool can read automatically. You must create the Qdrant collection manually before running the migration.
