---
title: Migrate from Apache Solr to Qdrant
source: https://qdrant.tech/documentation/migrate-to-qdrant/from-solr/
---
...
**Important:** Solr does not reliably expose vector dimensions and distance metrics via its schema API. You must create the Qdrant collection manually before running the migration.
