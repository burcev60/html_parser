...
source: https://qdrant.tech/documentation/examples/cohere-rag-connector/
---
...
_Source:<https://docs.cohere.com/docs/retrieval-augmented-generation-rag>_
