...
To build a robust and trustworthy medical chatbot, we will combine the following technologies:
  ...
  * [**Stanford DSPy**](https://qdrant.tech/documentation/frameworks/dspy/) ([local](./../frameworks/dspy.md))**:** DSPy is the AI framework we will use to obtain the final answer. It allows the medical bot to retrieve the relevant information and reason step-by-step to produce accurate and explainable answers.
