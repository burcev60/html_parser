...
source: https://qdrant.tech/documentation/examples/rag-chatbot-red-hat-openshift-haystack/
---
...
_Source:<https://docs.haystack.deepset.ai/docs/linkcontentfetcher>_
...
## Next steps
  ...
  * If you are just getting started and need more guidance on Qdrant, read the [quickstart](https://qdrant.tech/documentation/quickstart/) ([local](./../../02_local-quickstart.md)) or try out our [beginner tutorial](https://qdrant.tech/documentation/tutorials-search-engineering/neural-search/) ([local](./../../09_tutorials/03_search-engineering/04_semantic-search-basics.md)).
