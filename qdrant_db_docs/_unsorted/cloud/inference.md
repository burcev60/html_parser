---
title: Inference in Qdrant Managed Cloud
source: https://qdrant.tech/documentation/cloud/inference/
---

# Inference in Qdrant Managed Cloud

[Inference](https://qdrant.tech/documentation/inference/) ([local](./../../05_inference.md)) is the process of creating vector embeddings from text, images, or other data types using a machine learning model.
...
![Cluster Cluster UI](https://qdrant.tech/documentation/cloud/cloud-inference.png)
...
Inference can be easily used through the Qdrant SDKs and the REST or GRPC APIs when upserting points and when querying the database. Refer to the [Inference documentation](https://qdrant.tech/documentation/inference/) ([local](./../../05_inference.md)) for details.
