---
title: Monitoring Qdrant Cloud Clusters
source: https://qdrant.tech/documentation/cloud/cluster-monitoring/
---
...
You can learn about high-availability and production readiness [here](https://qdrant.tech/documentation/cloud/create-cluster/?q=high#creating-a-production-ready-cluster) ([local](./create-cluster/q-high.md#creating-a-production-ready-cluster)).

You can learn about vertical scaling [here](https://qdrant.tech/documentation/cloud/cluster-scaling/#vertical-scaling) ([local](./cluster-scaling.md#vertical-scaling)).

You can learn about horizontal scaling [here](https://qdrant.tech/documentation/cloud/cluster-scaling/#horizontal-scaling) ([local](./cluster-scaling.md#horizontal-scaling)).
...
You can learn more about disk capacity [here](https://qdrant.tech/documentation/capacity-planning/#scaling-disk-space-in-qdrant-cloud) ([local](./../capacity-planning.md#scaling-disk-space-in-qdrant-cloud)).

You can learn about vertical scaling [here](https://qdrant.tech/documentation/cloud/cluster-scaling/#vertical-scaling) ([local](./cluster-scaling.md#vertical-scaling)).

You can learn about horizontal scaling [here](https://qdrant.tech/documentation/cloud/cluster-scaling/#horizontal-scaling) ([local](./cluster-scaling.md#horizontal-scaling)).

You can learn about re-sharding [here](https://qdrant.tech/documentation/cloud/cluster-scaling/#resharding) ([local](./cluster-scaling.md#resharding)).
...
It is also possible to split collections across clusters, the [Qdrant Migration CLI](https://qdrant.tech/documentation/tutorials-operations/migration/) ([local](./../../09_tutorials/05_operations-scale/02_data-migration.md)) can help you with this.

**Where can I learn more about this alert?**

You can learn more about how to set up multi-tenancy with a Qdrant collection [here](https://qdrant.tech/documentation/manage-data/multitenancy/) ([local](./../../04_user-manual/01_manage-data/08_multitenancy.md)).
...
Learn more about updating your cluster [here](https://qdrant.tech/documentation/cloud/cluster-upgrades/) ([local](./cluster-upgrades.md))
...
Learn about the SDKs [here](https://qdrant.tech/documentation/interfaces/) ([local](./../../07_api-sdks.md)).

Learn more about JWT Keys and permissions [here](https://qdrant.tech/documentation/security/?q=jwt#granular-access-control-with-jwt) ([local](./../security/q-jwt.md#granular-access-control-with-jwt)).
...
Learn how to optimize Qdrant for performance and configure indexing [here](https://qdrant.tech/documentation/manage-data/indexing/) ([local](./../../04_user-manual/01_manage-data/06_indexing.md)) and [here](https://qdrant.tech/documentation/ops-optimization/optimize/) ([local](./../ops-optimization/optimize.md)).

Learn about optimizers [here](https://qdrant.tech/documentation/ops-optimization/optimizer/) ([local](./../ops-optimization/optimizer.md)).

Learn more about hybrid search [here](https://qdrant.tech/documentation/search/hybrid-queries/) ([local](./../../04_user-manual/03_search/03_hybrid-queries.md)).
...
Learn more about cloud rebalancing [here](https://qdrant.tech/documentation/cloud/configure-cluster/#shard-rebalancing) ([local](./configure-cluster.md#shard-rebalancing)).
...
Learn more about distributed deployments and resharding [here](https://qdrant.tech/documentation/distributed_deployment/#resharding) ([local](./../distributed-deployment.md#resharding)).
...
To scrape metrics from a Qdrant cluster running in Qdrant Cloud, an [API key](https://qdrant.tech/documentation/cloud/authentication/) ([local](./authentication.md)) is required to access `/metrics` and `/sys_metrics`. Qdrant Cloud also supports supplying the API key as a [Bearer token](https://www.rfc-editor.org/rfc/rfc6750.html), which may be required by some providers.

### Qdrant Node Metrics

Metrics in a Prometheus-compatible format are available at the `/metrics` endpoint of each Qdrant database node. When scraping, you should use the [node specific URLs](https://qdrant.tech/documentation/cloud/cluster-access/#node-specific-endpoints) ([local](./cluster-access.md#node-specific-endpoints)) to ensure that you are scraping metrics from all nodes in each cluster. For more information, see [Qdrant monitoring](https://qdrant.tech/documentation/ops-monitoring/monitoring/) ([local](./../ops-monitoring/monitoring.md)).
...
For more information, see [Qdrant monitoring](https://qdrant.tech/documentation/ops-monitoring/monitoring/) ([local](./../ops-monitoring/monitoring.md)).
...
![Grafana dashboard](https://qdrant.tech/documentation/cloud/cloud-grafana-dashboard.png)
...
cluster_commit| |   
cluster_enabled| | Indicates whether multi-node clustering is enabled  
