---
title: Configure Qdrant Cloud Clusters
source: https://qdrant.tech/documentation/cloud/configure-cluster/
---
...
The cloud platform does not expose all [configuration options](https://qdrant.tech/documentation/ops-configuration/configuration/) ([local](./../ops-configuration/configuration.md)) available in Qdrant. We have selected the relevant options that are explained in detail below.
...
In addition, the cloud platform automatically configures the following settings for your cluster to ensure optimal performance and reliability:
  ...
  * The maximum number of collections in a cluster is set to 1000. Larger numbers of collections lead to performance degradation. For more information see [Multitenancy](https://qdrant.tech/documentation/manage-data/multitenancy/) ([local](./../../04_user-manual/01_manage-data/08_multitenancy.md)).
  * To improve performance and reliability, [strict mode](https://qdrant.tech/documentation/ops-configuration/administration/#strict-mode) ([local](./../ops-configuration/administration.md#strict-mode)) is activated by default for new collections, with the following restrictions:
...
![Cluster node endpoints](https://qdrant.tech/documentation/cloud/cloud-advanced-configuration.png)
...
You can configure the default _Replication Factor_ , the default _Write Consistency Factor_ , and if vectors should be stored on disk only, instead of being cached in RAM.

Refer to [Qdrant Configuration](https://qdrant.tech/documentation/ops-configuration/configuration/#configuration-options) ([local](./../ops-configuration/configuration.md#configuration-options)) for more details.
...
Enables async scorer which uses io_uring when rescoring. See [Qdrant under the hood: io_uring](https://qdrant.tech/articles/io_uring/#and-what-about-qdrant) and [Large Scale Search](https://qdrant.tech/documentation/tutorials-operations/large-scale-search/) ([local](./../../09_tutorials/05_operations-scale/05_large-scale-search.md)) for more details.
...
![Cluster node endpoints](https://qdrant.tech/documentation/cloud/cloud-ip-restrictions.png)
...
![Cluster node endpoints](https://qdrant.tech/documentation/cloud/cloud-restart-mode.png)
...
![Cluster node endpoints](https://qdrant.tech/documentation/cloud/cloud-shard-rebalancing.png)

## Rename a Cluster

You can rename a Qdrant Cluster from the cluster’s detail page.

![Cluster Actions](https://qdrant.tech/documentation/cloud/cloud-cluster-actions.png)
...
![Rename Cluster Dialog](https://qdrant.tech/documentation/cloud/cloud-rename-cluster.png)
...
![Cluster Labels](https://qdrant.tech/documentation/cloud/cloud-cluster-labels.png)
