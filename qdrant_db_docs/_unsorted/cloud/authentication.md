---
title: Database Authentication in Qdrant Managed Cloud
source: https://qdrant.tech/documentation/cloud/authentication/
---
...
Database API keys can be configured with granular access control. Database API keys with granular access control can be recognized by starting with `eyJhb`. Please refer to the [Table of access](https://qdrant.tech/documentation/security/#table-of-access) ([local](./../security.md#table-of-access)) to understand what permissions you can configure.
...
Now that you have created your first cluster and key, you might want to access your database from within your application. Our [official Qdrant clients](https://qdrant.tech/documentation/interfaces/) ([local](./../../07_api-sdks.md)) for Python, TypeScript, Go, Rust, .NET and Java all support the API key parameter.
