---
title: Managing a Qdrant Cluster
source: https://qdrant.tech/documentation/private-cloud/qdrant-cluster-management/
---
...
There are lots more configuration options to configure scheduling, security, networking, and more. For full details see the [Qdrant Private Cloud API Reference](https://qdrant.tech/documentation/private-cloud/api-reference/) ([local](./api-reference.md)).
...
If you set the `jwt_rbac` flag, you will also be able to create granular [JWT tokens for role based access control](https://qdrant.tech/documentation/security/#granular-access-control-with-jwt) ([local](./../security.md#granular-access-control-with-jwt)).
...
For more GPU configuration options, see the [Qdrant Private Cloud API Reference](https://qdrant.tech/documentation/private-cloud/api-reference/) ([local](./api-reference.md)).
...
For a list of all available rebalancing strategies, see the [Qdrant Private Cloud API Reference](https://qdrant.tech/documentation/private-cloud/api-reference/#rebalancestrategy) ([local](./api-reference.md#rebalancestrategy)).
