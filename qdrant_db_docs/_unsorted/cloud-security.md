---
title: Qdrant Cloud Security
source: https://qdrant.tech/documentation/cloud-security/
---
...
All storage volumes are encrypted at rest. [Premium customers](https://qdrant.tech/documentation/cloud-premium/) ([local](./cloud-premium.md)) can also bring their own encryption keys for storage volumes.

Data in transit is protected with Transport-Layer-Security (TLS). It is possible to restrict the [IP ranges](https://qdrant.tech/documentation/cloud/configure-cluster/#client-ip-restrictions) ([local](./cloud/configure-cluster.md#client-ip-restrictions)) that are allowed to access a cluster.
...
Access to Qdrant Cloud accounts can be configured with granular [Role-Based Access Control](https://qdrant.tech/documentation/cloud-rbac/) ([local](./cloud-rbac.md)). [Premium customers](https://qdrant.tech/documentation/cloud-premium/) ([local](./cloud-premium.md)) can also enable [Single Sign-On (SSO)](https://qdrant.tech/documentation/cloud-account-setup/#enterprise-single-sign-on-sso) ([local](./cloud-account-setup.md#enterprise-single-sign-on-sso)) with their identity provider.

[API keys](https://qdrant.tech/documentation/cloud-api/#authentication) ([local](./cloud-api.md#authentication)) can be configured with granular access controls and rotated at any time. API Keys are never stored in plaintext.
...
Please refer to our [Hybrid Cloud documentation](https://qdrant.tech/documentation/hybrid-cloud/) ([local](./hybrid-cloud.md)) for more details.
