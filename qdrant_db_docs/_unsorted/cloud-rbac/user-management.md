...
source: https://qdrant.tech/documentation/cloud-rbac/user-management/
---

# User Management

> 💡 You can access this in **Access Management > User & Role Management** _if available see[this page for details](https://qdrant.tech/documentation/cloud-rbac/) ([local](./../cloud-rbac.md))._
...
![image.png](https://qdrant.tech/documentation/cloud/role-based-access-control/user-invitation.png) ![image.png](https://qdrant.tech/documentation/cloud/role-based-access-control/user-addition.png)
...
![image.png](https://qdrant.tech/documentation/cloud/role-based-access-control/make-account-owner.png)
