...
source: https://qdrant.tech/documentation/cloud-rbac/permission-reference/
---
...
`read:users`| View user details in the profile page.  
\- Also applicable in User Management and Role details (User tab).  
`delete:users`| Remove users from an account.  
\- Applicable in User Management and Role details (User tab).  
...
Permission| Description  
---|---  
`read:cluster_data`| View cluster data, used for the Cluster UI button on Cluster Details. [Maps to global `read-only` JWT access for the cluster.](https://qdrant.tech/documentation/security/) ([local](./../security.md))  
`write:cluster_data`| View and modify cluster data, used for the Cluster UI button on Cluster Details. [Maps to global `read-write` JWT access for the cluster.](https://qdrant.tech/documentation/security/) ([local](./../security.md))  
...
`write:account`| Modify account details such as:  
\- Editing the account name  
\- Setting an account as default  
\- Leaving an account  
**(Only available to Owners)**  
`delete:account`| Remove an account from:  
