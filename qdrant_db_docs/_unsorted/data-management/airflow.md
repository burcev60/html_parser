...
source: https://qdrant.tech/documentation/data-management/airflow/
---
...
Before configuring Airflow, you need:
  ...
  1. A Qdrant instance to connect to. You can set one up in our [installation guide](https://qdrant.tech/documentation/installation/) ([local](./../installation.md)).
