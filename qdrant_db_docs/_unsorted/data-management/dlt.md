...
source: https://qdrant.tech/documentation/data-management/dlt/
---
...
The location will default to `http://localhost:6333` and `api_key` is not defined - which are the defaults for a local Qdrant instance. Find more information about DLT configurations [here](https://dlthub.com/docs/general-usage/credentials).
...
A more comprehensive pipeline would load data from some API or use one of [DLT's verified sources](https://dlthub.com/docs/dlt-ecosystem/verified-sources).
