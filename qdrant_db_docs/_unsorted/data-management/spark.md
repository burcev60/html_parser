---
title: Apache Spark
source: https://qdrant.tech/documentation/data-management/spark/
---
...
Before loading the data using this connector, a collection has to be [created](https://qdrant.tech/documentation/manage-data/collections/#create-a-collection) ([local](./../../04_user-manual/01_manage-data/04_collections.md#create-a-collection)) in advance with the appropriate vector dimensions and configurations.
...
Check out our [example](https://qdrant.tech/documentation/send-data/databricks/) ([local](./../send-data/databricks.md)) of using the Spark connector with Databricks.
