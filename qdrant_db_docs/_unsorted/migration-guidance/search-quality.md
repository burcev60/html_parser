---
title: Search Quality Verification
source: https://qdrant.tech/documentation/migration-guidance/search-quality/
---
...
Run your [baseline queries](https://qdrant.tech/documentation/migration-guidance/pre-migration-baseline/) ([local](./pre-migration-baseline.md)) against Qdrant and eyeball the results. This catches configuration-level errors that would affect every query: wrong distance metric, missing index, broken filter logic.
...
**If Tier 1 fails:** Stop. The issue is almost certainly a configuration problem (distance metric, missing index, filter translation error). Go to [Diagnosing Discrepancies](https://qdrant.tech/documentation/migration-guidance/diagnosing-discrepancies/) ([local](./diagnosing-discrepancies.md)) before running further checks.
...
**If Tier 2 passes but a few queries have low recall:** This is normal. Check whether the low-recall queries involve highly selective filters or edge cases. See [Diagnosing Discrepancies](https://qdrant.tech/documentation/migration-guidance/diagnosing-discrepancies/) ([local](./diagnosing-discrepancies.md)).
...
Tier 3 measures whether search results are _relevant_ , not merely consistent with the source system. This requires labeled relevance judgments: for a set of queries, human-verified labels indicating which documents are relevant.

### Why Tier 3 Matters

Tier 2 assumes the source system’s results are the ground truth. But if you’re migrating because your source system’s search quality was insufficient, matching its results perfectly is the wrong goal. Tier 3 measures against what the results _should_ be, not what they were.

### Building an Evaluation Set

If you don’t have labeled data, here are three practical approaches to build one:

**Approach A: Click/Conversion Logs (Lowest Effort)**
...
**Approach B: Expert Labeling (Moderate Effort)**
...
**Approach C: Synthetic Evaluation (Lowest Barrier)**
...
**Next:** [Diagnosing Discrepancies](https://qdrant.tech/documentation/migration-guidance/diagnosing-discrepancies/) ([local](./diagnosing-discrepancies.md))
