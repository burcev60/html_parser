...
source: https://qdrant.tech/documentation/migration-guidance/data-integrity/
---

# Data Integrity Verification

Once you’ve established a [baseline](https://qdrant.tech/documentation/migration-guidance/pre-migration-baseline/) ([local](./pre-migration-baseline.md)), you first need to check data integrity. Data integrity answers the question: “Did all my data arrive, and did it arrive correctly?” These are the fastest checks to run and catch the most common migration failures.
...
**Next:** [Search Quality Verification](https://qdrant.tech/documentation/migration-guidance/search-quality/) ([local](./search-quality.md))
