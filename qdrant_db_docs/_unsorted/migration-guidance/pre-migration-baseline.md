...
source: https://qdrant.tech/documentation/migration-guidance/pre-migration-baseline/
---
...
**How much to sample:** At least 1,000 records or 1% of your data, _whichever is larger_. For datasets under 100K vectors, consider exporting all metadata.
...
**Next:** [Data Integrity Verification](https://qdrant.tech/documentation/migration-guidance/data-integrity/) ([local](./data-integrity.md))
