...
source: https://qdrant.tech/documentation/data-synchronization/with-postgres/
---
...
![Choosing your sync tier](https://qdrant.tech/documentation/data-synchronization/tier_descision_tree.png)
...
![Tier 1: Dual-write architecture](https://qdrant.tech/documentation/data-synchronization/tier_1_dual_writes.png)
...
Instead of writing to Qdrant directly from the request handler, we write an _event_ into a `sync_outbox` table in the **same Postgres transaction** as the product write. A background worker picks up these events and syncs them to Qdrant asynchronously.
...
![Tier 2: Transactional outbox architecture](https://qdrant.tech/documentation/data-synchronization/tier_2_background_worker.png)
...
![Tier 3: Change Data Capture architecture](https://qdrant.tech/documentation/data-synchronization/tier_3_debezium_kafka.png)
...
With dual-write (Tier 1) or the outbox (Tier 2), a full rebuild requires running a bulk export from Postgres. With CDC, the event stream _is_ the rebuild mechanism.
