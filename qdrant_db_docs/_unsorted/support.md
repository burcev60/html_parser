---
title: Qdrant Cloud Support and Troubleshooting
source: https://qdrant.tech/documentation/support/
---
...
> Please refer to the [Qdrant Cloud SLA](https://qdrant.to/sla/) for full definitions of severity levels and guaranteed response times per your [support tier](https://qdrant.tech/documentation/cloud-premium/) ([local](./cloud-premium.md)).
