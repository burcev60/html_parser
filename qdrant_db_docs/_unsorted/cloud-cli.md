...
source: https://qdrant.tech/documentation/cloud-cli/
---
...
Before using `qcloud`, create a [management API](https://qdrant.tech/documentation/cloud-api/) ([local](./cloud-api.md)) key and note your account ID from the [Qdrant Cloud Console](https://cloud.qdrant.io).
