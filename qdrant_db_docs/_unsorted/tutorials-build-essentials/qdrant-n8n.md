---
title: Automate Qdrant Workflows with n8n
source: https://qdrant.tech/documentation/tutorials-build-essentials/qdrant-n8n/
---
...
Since this tutorial was created, [an official Qdrant node for n8n](https://qdrant.tech/documentation/platforms/n8n/) ([local](./../platforms/n8n.md)) has been released. It simplifies workflows and replaces the HTTP request nodes used in the examples below. Watch [a quick video introduction](https://youtu.be/sYP_kHWptHY) to it.
...
To connect [Qdrant Cloud](https://qdrant.tech/documentation/cloud/) ([local](./../cloud.md)) to n8n:
...
This kit includes a [local instance of Qdrant](https://qdrant.tech/documentation/quickstart/) ([local](./../../02_local-quickstart.md)). To get started:
...
![overview](https://qdrant.tech/documentation/examples/qdrant-n8n-2/overview.png)
...
![recommendations](https://qdrant.tech/documentation/examples/qdrant-n8n-2/recommendations.png)
...
One definition of “anomaly” comes intuitively after projecting vector representations of data points into a 2D space—[Qdrant webUI](https://qdrant.tech/documentation/web-ui/) ([local](./../../06_qdrant-web-ui.md)) provides this functionality.

Points that don’t belong to any clusters are more likely to be anomalous.

![anomalies-on-2D](https://qdrant.tech/documentation/examples/qdrant-n8n-2/anomalies-2D.png)
...
![anomaly-detection](https://qdrant.tech/documentation/examples/qdrant-n8n-2/anomaly-detection.png)
...
An [1/3 Uploading Images to Qdrant Template Workflow](https://n8n.io/workflows/2654-vector-database-as-a-big-data-analysis-tool-for-ai-agents-13-anomaly12-knn/) consists of the following blocks:
  ...
  2. **Payload Index** : Adds a [payload index](https://qdrant.tech/documentation/manage-data/indexing/#payload-index) ([local](./../../04_user-manual/01_manage-data/06_indexing.md#payload-index)) on the `crop_name` payload (metadata) field. This field stores crop class labels, and indexing it improves the speed of filterable searches in Qdrant. It changes the way a vector index is constructed, adapting it for fast vector search under filtering constraints. For more details, refer to this [guide on filtering in Qdrant](https://qdrant.tech/articles/vector-search-filtering/).
...
2\. Compute a **pairwise distance matrix** for the cluster using Qdrant’s [Distance Matrix API](https://qdrant.tech/documentation/search/explore/?q=distance+#distance-matrix) ([local](./../search/explore/q-distance.md#distance-matrix)). This API helps with scalable cluster analysis and data points relationship exploration. Learn more in [this article](https://qdrant.tech/articles/distance-based-exploration/).  
...
![KNN-2D](https://qdrant.tech/documentation/examples/qdrant-n8n-2/classification.png)
