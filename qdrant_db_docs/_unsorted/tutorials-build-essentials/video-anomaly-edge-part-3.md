---
title: Video Anomaly Detection: Scoring, Governance, and Deployment
source: https://qdrant.tech/documentation/tutorials-build-essentials/video-anomaly-edge-part-3/
---
...
---|---|---  
 ...
 _This is Part 3 of a 3-part series on building real-time video anomaly detection from edge to cloud._
...
In [Part 1](https://qdrant.tech/documentation/tutorials-build-essentials/video-anomaly-edge-part-1/) ([local](./video-anomaly-edge-part-1.md)), we set up the architecture, Twelve Labs integration, and NVIDIA VSS connection. In [Part 2](https://qdrant.tech/documentation/tutorials-build-essentials/video-anomaly-edge-part-2/) ([local](./video-anomaly-edge-part-2.md)), we built Qdrant Edge’s two-shard architecture and the escalation pipeline. Now we turn raw scores into incidents, protect the baseline, and deploy.
...
If you’re starting fresh, return to [Part 1](https://qdrant.tech/documentation/tutorials-build-essentials/video-anomaly-edge-part-1/) ([local](./video-anomaly-edge-part-1.md)) for setup instructions.
...
Two thresholds prevent flickering between “incident” and “normal” states:
  ...
  * **t_high = 0.045** : Smoothed score must exceed this to _start_ an incident
  * **t_low = 0.025** : Score must drop below this to _end_ an incident
...
![Baseline governance: quarantine, scrubbing, and poisoning prevention to maintain detection quality](https://qdrant.tech/articles_data/video-anomaly-edge/governance.png)
...
![UMAP scatter plot of video embeddings showing normal baseline clusters and anomaly outliers in vector space](https://qdrant.tech/articles_data/video-anomaly-edge/umap-scatter.png)
...
![Benchmark results on UCF-Crime dataset](https://qdrant.tech/articles_data/video-anomaly-edge/benchmark-results.png)
...
The key takeaways:
  ...
  * **Twelve Labs for both scoring and understanding** : Marengo embeddings power the kNN detector _and_ semantic search. Pegasus adds conversational Q&A. One platform, both jobs.
