---
title: https://qdrant.tech/documentation/cloud-tools/terraform/
source: https://qdrant.tech/documentation/cloud-tools/terraform/
---
...
To use the Qdrant Terraform Provider, you’ll need:
  ...
  2. An [API key](https://qdrant.tech/documentation/cloud-api/#authentication) ([local](./../cloud-api.md#authentication)) to access the Qdrant cloud API.
