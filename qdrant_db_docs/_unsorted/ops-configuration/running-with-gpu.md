...
source: https://qdrant.tech/documentation/ops-configuration/running-with-gpu/
---
...
The maximum size of each segment can be configured in the collection settings. Use the following operation to [change](https://qdrant.tech/documentation/manage-data/collections/#update-collection-parameters) ([local](./../../04_user-manual/01_manage-data/04_collections.md#update-collection-parameters)) on your existing collection:
