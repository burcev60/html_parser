---
title: LangGraph
source: https://qdrant.tech/documentation/frameworks/langgraph/
---
...
LangGraph works seamlessly with all the components of LangChain. This means we can utilize Qdrant’s [Langchain integration](https://qdrant.tech/documentation/frameworks/langchain/) ([local](./langchain.md)) to create retrieval nodes in LangGraph, available in both Python and Javascript!
