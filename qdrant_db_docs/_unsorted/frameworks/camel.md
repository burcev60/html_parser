---
title: Camel
source: https://qdrant.tech/documentation/frameworks/camel/
---
...
You can refer to the Camel [documentation](https://docs.camel-ai.org/) for more information about the retrieval mechanisms.
