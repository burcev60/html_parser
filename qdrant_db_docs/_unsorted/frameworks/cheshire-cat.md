---
title: Cheshire Cat
source: https://qdrant.tech/documentation/frameworks/cheshire-cat/
---
...
Cheshire Cat takes great advantage of the following features of Qdrant:
  ...
  * [Collection Aliases](https://qdrant.tech/documentation/manage-data/collections/#collection-aliases) ([local](./../../04_user-manual/01_manage-data/04_collections.md#collection-aliases)) to manage the change from one embedder to another.
  * [Quantization](https://qdrant.tech/documentation/manage-data/quantization/) ([local](./../../04_user-manual/01_manage-data/07_quantization.md)) to obtain a good balance between speed, memory usage and quality of the results.
  * [Snapshots](https://qdrant.tech/documentation/snapshots/) ([local](./../snapshots.md)) to not miss any information.
