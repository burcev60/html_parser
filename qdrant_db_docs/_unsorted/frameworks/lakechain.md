---
title: AWS Lakechain
source: https://qdrant.tech/documentation/frameworks/lakechain/
---
...
You can find an end-to-end example usage of the Qdrant Lakechain connector [here.](https://github.com/awslabs/project-lakechain/tree/main/examples/simple-pipelines/embedding-pipelines/bedrock-qdrant-pipeline)
...
Since Qdrant supports [multiple vectors](https://qdrant.tech/documentation/manage-data/vectors/#named-vectors) ([local](./../../04_user-manual/01_manage-data/02_vectors.md#named-vectors)) per point, you can use the `withVectorName` option to specify one. The connector defaults to unnamed (default) vector.
