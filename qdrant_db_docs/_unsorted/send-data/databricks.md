---
title: Ingest Databricks Data into Qdrant
source: https://qdrant.tech/documentation/send-data/databricks/
---
...
In this example, we will demonstrate how to vectorize a dataset with dense and sparse embeddings using Qdrant’s [FastEmbed](https://qdrant.github.io/fastembed/) library. We will then load this vectorized data into a Qdrant cluster using the [Qdrant Spark connector](https://qdrant.tech/documentation/data-management/spark/) ([local](./../data-management/spark.md)) on Databricks.
...
### Setting up a Databricks project
  ...
  * Install the **[Qdrant Spark connector](https://qdrant.tech/documentation/data-management/spark/) ([local](./../data-management/spark.md))** as a library:
...
### Uploading the data to Qdrant
  ...
  * **Create a Qdrant collection:**
    ...
    * [Follow the documentation](https://qdrant.tech/documentation/manage-data/collections/#create-a-collection) ([local](./../../04_user-manual/01_manage-data/04_collections.md#create-a-collection)) to create a collection with the appropriate configurations. Here’s an example request to support both dense and sparse vectors:
