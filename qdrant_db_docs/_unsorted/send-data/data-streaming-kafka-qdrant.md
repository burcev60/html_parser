---
title: Stream Real-Time Data into Qdrant with Kafka and Confluent
source: https://qdrant.tech/documentation/send-data/data-streaming-kafka-qdrant/
---
...
This will download the Qdrant image and start a Qdrant instance accessible at `http://localhost:6333`. For more detailed instructions and alternative installation methods, refer to the [Qdrant installation documentation](https://qdrant.tech/documentation/quickstart/) ([local](./../../02_local-quickstart.md)).
