---
title: Apify
source: https://qdrant.tech/documentation/platforms/apify/
---
...
Upon running the script, the data from <https://qdrant.tech/documentation/> ([local](./../../index.md)) will be scraped, transformed into vector embeddings and stored in the Qdrant collection.
