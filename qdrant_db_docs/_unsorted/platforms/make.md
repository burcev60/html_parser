---
title: Make.com
source: https://qdrant.tech/documentation/platforms/make/
---
...
Navigate to your scenario on the Make dashboard and select a Qdrant app module to start a connection. ![Qdrant Make connection](https://qdrant.tech/documentation/frameworks/make/connection.png)

You can now establish a connection to Qdrant using your [instance credentials](https://qdrant.tech/documentation/cloud/authentication/) ([local](./../cloud/authentication.md)).
...
The Qdrant Make app enables you to trigger the following app modules. ![Qdrant Make modules](https://qdrant.tech/documentation/frameworks/make/modules.png)
