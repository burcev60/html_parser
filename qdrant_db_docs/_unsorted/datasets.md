---
title: Common Datasets in Snapshot Format
source: https://qdrant.tech/documentation/datasets/
---
...
Once you download a snapshot, you need to [restore it](https://qdrant.tech/documentation/snapshots/#restore-snapshot) ([local](./snapshots.md#restore-snapshot)) using the Qdrant CLI upon startup or through the API.
...
If you are not familiar with [Hugging Face datasets](https://huggingface.co/docs/datasets/index), or would like to know how to combine it with Qdrant, please refer to the [tutorial](https://qdrant.tech/documentation/tutorials-basics/huggingface-datasets/) ([local](./tutorials-basics/huggingface-datasets.md)).
