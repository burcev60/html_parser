---
title: Creating a Qdrant Cluster in Hybrid Cloud
source: https://qdrant.tech/documentation/hybrid-cloud/hybrid-cloud-cluster-creation/
---

# Creating a Qdrant Cluster in Hybrid Cloud

Once a Hybrid Cloud Environment has been created you can follow the normal process to [create a Qdrant cluster](https://qdrant.tech/documentation/cloud/create-cluster/) ([local](./../cloud/create-cluster.md)) in that environment. This page also contains additional information on how to create a [production-ready cluster](https://qdrant.tech/documentation/cloud/create-cluster/#creating-a-production-ready-cluster) ([local](./../cloud/create-cluster.md#creating-a-production-ready-cluster)).
...
After configuring the API key secret, you can create JWTs with granular access control in the Qdrant Cluster UI. Please refer to the [Granular access control with JWT](https://qdrant.tech/documentation/security/#granular-access-control-with-jwt) ([local](./../security.md#granular-access-control-with-jwt)) documentation for more details.
