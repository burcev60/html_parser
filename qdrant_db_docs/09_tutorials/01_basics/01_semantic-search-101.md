---
title: Build a Semantic Search Engine in 5 Minutes
source: https://qdrant.tech/documentation/tutorials-basics/search-beginners/
---
...
>   * Alternatively, you can run Qdrant on your own machine. This requires you to manage your own cluster and vector embedding infrastructure. If you prefer this option, check out the [local deployment version of this tutorial](https://qdrant.tech/documentation/tutorials-basics/search-beginners-local/) ([local](./../../_unsorted/tutorials-basics/search-beginners-local.md)).
> 
...
Replace `QDRANT_URL` and `QDRANT_API_KEY` with the cluster endpoint and API key you obtained in the previous step. The `cloud_inference=True` parameter enables Qdrant Cloud’s [inference](https://qdrant.tech/documentation/inference/) ([local](./../../05_inference.md)) capabilities, allowing the cluster to generate vector embeddings without the need to manage your own embedding infrastructure.

## 3\. Create a Collection

All data in Qdrant is organized within [collections](https://qdrant.tech/documentation/manage-data/collections/) ([local](./../../04_user-manual/01_manage-data/04_collections.md)). Since you’re storing books, let’s create a collection named `my_books`.
...
Store each book as a [point](https://qdrant.tech/documentation/manage-data/points/) ([local](./../../04_user-manual/01_manage-data/01_points.md)) in the `my_books` collection, with each point consisting of a [unique ID](https://qdrant.tech/documentation/manage-data/points/#point-ids) ([local](./../../04_user-manual/01_manage-data/01_points.md#point-ids)), a [vector](https://qdrant.tech/documentation/manage-data/vectors/) ([local](./../../04_user-manual/01_manage-data/02_vectors.md)) generated from the description, and a [payload](https://qdrant.tech/documentation/manage-data/payload/) ([local](./../../04_user-manual/01_manage-data/03_payload.md)) containing the book’s metadata:
...
How about the most recent book from the early 2000s? Qdrant allows you to narrow down query results by applying a [filter](https://qdrant.tech/documentation/search/filtering/) ([local](./../../04_user-manual/03_search/02_filtering.md)). To filter for books published after the year 2000, you can filter on the `year` field in the payload.

Before filtering on a payload field, create a [payload index](https://qdrant.tech/documentation/manage-data/indexing/#payload-index) ([local](./../../04_user-manual/01_manage-data/06_indexing.md#payload-index)) for that field:
...
Congratulations, you have just created your very first search engine! Trust us, the rest of Qdrant is not that complicated, either. For your next tutorial, try [building your own hybrid search service](https://qdrant.tech/documentation/tutorials-search-engineering/hybrid-search-fastembed/) ([local](./../03_search-engineering/07_hybrid-search-with-fastembed.md)) or take the free [Qdrant Essentials course](https://qdrant.tech/course/essentials/).
