---
title: Migrate to a New Embedding Model with Zero Downtime in Qdrant
source: https://qdrant.tech/documentation/tutorials-operations/embedding-model-migration/
---
...
This tutorial assumes you use [Qdrant Cloud Inference](https://qdrant.tech/documentation/inference/#qdrant-cloud-inference) ([local](./../../05_inference.md#qdrant-cloud-inference)) to generate vector embeddings. If you manage your own embedding infrastructure, you can apply the same principles, but you will need to adapt the code examples to use your embedding service.
...
Please refer to the [documentation of the SDK you are using](https://qdrant.tech/documentation/interfaces/) ([local](./../../07_api-sdks.md)), or the [HTTP](https://api.qdrant.tech/api-reference)/[gRPC](https://api.qdrant.tech/api-reference) definitions, for the exact method names, as they may vary between languages.
...
Breaking down this code step by step:
  ...
  * Data is read from the old collection in batches of 100 points using a [scroll](https://qdrant.tech/documentation/manage-data/points/#scroll-points) ([local](./../../04_user-manual/01_manage-data/01_points.md#scroll-points)). The `last_offset` variable keeps track of the scroll position in the collection.
...
Once the migration process is complete, and all the points from the old collection are re-embedded and stored in the new collection, you can roll out a configuration change of the backend application. There are two key changes you have to make:
  ...
  1. **The collection name**. Switch this from the old collection to the new collection. If you’re using a [collection alias](https://qdrant.tech/documentation/manage-data/collections/#collection-aliases) ([local](./../../04_user-manual/01_manage-data/04_collections.md#collection-aliases)), switch the alias to point to the new collection.
