...
source: https://qdrant.tech/documentation/tutorials-search-engineering/ann-recall/
---
...
ANN recall measures how closely approximate search matches exact kNN. It’s the first of four evaluation layers; each higher layer measures a different property of the retrieval system, with different tools.
  ...
  * **Retrieval relevance** ([Measuring Retrieval Relevance](https://qdrant.tech/documentation/improve-search/retrieval-relevance/) ([local](./../../_unsorted/improve-search/retrieval-relevance.md))). Do the top-k results match query intent?
  * **Pipeline output quality** ([Evaluating Pipeline Output Quality](https://qdrant.tech/documentation/improve-search/pipeline-output-quality/) ([local](./../../_unsorted/improve-search/pipeline-output-quality.md))). Does the end-to-end pipeline (retrieval + generator, ranker, or UI) produce the right output?
...
![ANN Recall tab with default evaluation results](https://qdrant.tech/documentation/tutorials/retrieval-quality/search-quality-tab.png)
...
![ANN Recall advanced mode with HNSW parameters](https://qdrant.tech/documentation/tutorials/retrieval-quality/search-quality-advanced.png)
...
Once ANN recall is on target, continue with [Measuring Retrieval Relevance](https://qdrant.tech/documentation/improve-search/retrieval-relevance/) ([local](./../../_unsorted/improve-search/retrieval-relevance.md)) to check how well those results match user intent.
