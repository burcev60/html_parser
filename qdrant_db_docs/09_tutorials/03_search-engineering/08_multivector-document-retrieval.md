---
title: Qdrant Multivector Document Retrieval with ColPali/ColQwen
source: https://qdrant.tech/documentation/tutorials-search-engineering/pdf-retrieval-at-scale/
---
...
Qdrant supports [multivector representations](https://qdrant.tech/documentation/manage-data/vectors/#multivectors) ([local](./../../04_user-manual/01_manage-data/02_vectors.md#multivectors)), making it well-suited for using embedding models such as ColPali, ColQwen, or [ColBERT](https://qdrant.tech/documentation/fastembed/fastembed-colbert/) ([local](./../../08_qdrant-tools/01_fastembed/06_working-with-colbert.md))
...
To understand the impact, consider the construction of an [**HNSW index**](https://qdrant.tech/articles/what-is-a-vector-database/#1-indexing-hnsw-index-and-sending-data-to-qdrant), a common indexing algorithm for vector databases. Let’s roughly estimate the number of comparisons needed to insert a new PDF page into the index.
  ...
  * **[ef_construct](https://qdrant.tech/documentation/manage-data/indexing/#vector-index) ([local](./../../04_user-manual/01_manage-data/06_indexing.md#vector-index)):** 100 (default)
