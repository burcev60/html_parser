---
title: How to Get Started with Qdrant Locally
...
By default, Qdrant starts with no encryption or authentication . This means anyone with network access to your machine can access your Qdrant container instance. Please read [Security](https://qdrant.tech/documentation/security/) ([local](./_unsorted/security.md)) carefully for details on how to secure your instance.
...
The results are returned in decreasing similarity order. Note that payload and vector data is missing in these results by default. See [payload and vector in the result](https://qdrant.tech/documentation/search/search/#payload-and-vector-in-the-result) ([local](./04_user-manual/03_search/01_search.md#payload-and-vector-in-the-result)) on how to enable it.
...
To make filtered search fast on real datasets, we highly recommend to create [payload indexes](https://qdrant.tech/documentation/manage-data/indexing/#payload-index) ([local](./04_user-manual/01_manage-data/06_indexing.md#payload-index))!

You have just conducted vector search. You loaded vectors into a database and queried the database with a vector of your own. Qdrant found the closest results and presented you with a similarity score.

## Next steps

Now you know how Qdrant works. Getting started with [Qdrant Cloud](https://qdrant.tech/documentation/cloud-quickstart/) ([local](./03_cloud-quickstart.md)) is just as easy. [Create an account](https://qdrant.to/cloud) and use our SaaS completely free. We will take care of infrastructure maintenance and software updates.

To move onto some more complex examples of vector search, read our [Tutorials](https://qdrant.tech/documentation/tutorials-lp-overview/) ([local](./10_overview.md)) and create your own app with the help of our [Examples](https://qdrant.tech/documentation/examples/) ([local](./_unsorted/examples.md)).
