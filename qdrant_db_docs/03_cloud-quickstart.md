---
title: Quick Start with Qdrant Cloud
source: https://qdrant.tech/documentation/cloud-quickstart/
---

# Quick Start with Qdrant Cloud

Learn how to set up Qdrant Cloud and perform your first semantic search in just a few minutes. We’ll use a sample dataset of menu items embedded with the `sentence-transformers/all-MiniLM-L6-v2` model via [Cloud Inference](https://qdrant.tech/documentation/inference/) ([local](./05_inference.md)). This is one of the free embedding models available on Qdrant Cloud. For a list of the available free and paid models, refer to the Inference tab of the Cluster Detail page in the Qdrant Cloud Console.
...
For detailed cluster setup instructions, see the [Cloud documentation](https://qdrant.tech/documentation/deploy-intro/) ([local](./02_deploy.md)).
...
## What’s Next?
  ...
  * Explore [filtering](https://qdrant.tech/documentation/search/filtering/) ([local](./04_user-manual/03_search/02_filtering.md)) to combine semantic search with structured queries
  * Learn about [collections](https://qdrant.tech/documentation/manage-data/collections/) ([local](./04_user-manual/01_manage-data/04_collections.md)) and advanced configuration options
  * Check out more [examples and tutorials](https://qdrant.tech/documentation/tutorials-lp-overview/) ([local](./10_overview.md))
