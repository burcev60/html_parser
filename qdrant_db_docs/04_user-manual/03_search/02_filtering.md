...
With Qdrant, you can set conditions when searching or retrieving points. For example, you can impose conditions on both the [payload](https://qdrant.tech/documentation/manage-data/payload/) ([local](./../01_manage-data/03_payload.md)) and the `id` of the point.
...
The simplest kind of condition is one that checks if the stored value equals the given one. If several values are stored, at least one of them should match the condition. You can apply it to [keyword](https://qdrant.tech/documentation/manage-data/payload/#keyword) ([local](./../01_manage-data/03_payload.md#keyword)), [integer](https://qdrant.tech/documentation/manage-data/payload/#integer) ([local](./../01_manage-data/03_payload.md#integer)) and [bool](https://qdrant.tech/documentation/manage-data/payload/#bool) ([local](./../01_manage-data/03_payload.md#bool)) payloads.
...
You can apply it to [keyword](https://qdrant.tech/documentation/manage-data/payload/#keyword) ([local](./../01_manage-data/03_payload.md#keyword)) and [integer](https://qdrant.tech/documentation/manage-data/payload/#integer) ([local](./../01_manage-data/03_payload.md#integer)) payloads.
...
Exact texts that will match the condition depend on full-text index configuration. Configuration is defined during the index creation and describe at [full-text index](https://qdrant.tech/documentation/manage-data/indexing/#full-text-index) ([local](./../01_manage-data/06_indexing.md#full-text-index)).
...
The `text_any` full-text match condition is similar to the `text` condition, but with a key difference: while `text` only matches text fields that contain _all_ the query terms, `text_any` matches fields that contain _any_ of the query terms. In other words, even if a text field contains just one of the query terms, it is considered a match.
...
A match `phrase` condition also leverages [full-text index](https://qdrant.tech/documentation/manage-data/indexing/#full-text-index) ([local](./../01_manage-data/06_indexing.md#full-text-index)), to perform exact phrase comparisons. It allows you to search for a specific token phrase within the text field.
...
Can be applied to [float](https://qdrant.tech/documentation/manage-data/payload/#float) ([local](./../01_manage-data/03_payload.md#float)) and [integer](https://qdrant.tech/documentation/manage-data/payload/#integer) ([local](./../01_manage-data/03_payload.md#integer)) payloads.

### Datetime Range

The datetime range is a unique range condition, used for [datetime](https://qdrant.tech/documentation/manage-data/payload/#datetime) ([local](./../01_manage-data/03_payload.md#datetime)) payloads, which supports RFC 3339 formats. You do not need to convert dates to UNIX timestamps. During comparison, timestamps are parsed and converted to UTC.
...
If several values are stored, at least one of them should match the condition. These conditions can only be applied to payloads that match the [geo-data format](https://qdrant.tech/documentation/manage-data/payload/#geo) ([local](./../01_manage-data/03_payload.md#geo)).
