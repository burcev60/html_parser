---
title: On-Device Embeddings with Qdrant Edge and FastEmbed
source: https://qdrant.tech/documentation/edge/edge-fastembed-embeddings/
---

# On-Device Embeddings with Qdrant Edge and FastEmbed

When using Python, you can use the [FastEmbed](https://qdrant.tech/documentation/fastembed/) ([local](./../../08_qdrant-tools/02_fastembed.md)) library to generate embeddings for use with Qdrant Edge. FastEmbed provides multimodal models that run efficiently on edge devices to generate vector embeddings from text and images.
...
First, initialize an Edge Shard as described in the [Qdrant Edge Quickstart Guide](https://qdrant.tech/documentation/edge/edge-quickstart/) ([local](./01_quickstart.md)).
