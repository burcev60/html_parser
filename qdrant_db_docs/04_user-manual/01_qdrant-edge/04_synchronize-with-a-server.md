---
title: Synchronize Qdrant Edge with a Server
source: https://qdrant.tech/documentation/edge/edge-synchronization-guide/
---
...
![Qdrant Edge Shards can be synchronized with a central server](https://qdrant.tech/documentation/edge/qdrant-edge-sync-with-server.png)
...
The mutable Edge Shard will manage local data updates. It can be initialized from scratch, as detailed in the [Qdrant Edge Quickstart Guide](https://qdrant.tech/documentation/edge/edge-quickstart/) ([local](./01_quickstart.md)).
...
Next, create the immutable Edge Shard from a snapshot on the server, as outlined in [Initialize Edge Shard from existing Qdrant Collection](https://qdrant.tech/documentation/edge/edge-data-synchronization-patterns/#initialize-edge-shard-from-existing-qdrant-collection) ([local](./03_data-synchronization-patterns.md#initialize-edge-shard-from-existing-qdrant-collection)):
...
With both Edge Shards initialized, you can implement a dual-write mechanism in your application as outlined in [Update a Server Collection from an Edge Shard](https://qdrant.tech/documentation/edge/edge-data-synchronization-patterns/#update-a-server-collection-from-an-edge-shard) ([local](./03_data-synchronization-patterns.md#update-a-server-collection-from-an-edge-shard)).
...
You can periodically update the immutable Edge Shard with changes from the server using partial snapshots, as described in [Update Qdrant Edge with Server-Side Changes](https://qdrant.tech/documentation/edge/edge-data-synchronization-patterns/#update-qdrant-edge-with-server-side-changes) ([local](./03_data-synchronization-patterns.md#update-qdrant-edge-with-server-side-changes)).
