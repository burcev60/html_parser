...
![Qdrant Edge Shards operate on edge devices](https://qdrant.tech/documentation/edge/qdrant-edge.png)
...
---|---|---  
**Beginner**| [Qdrant Edge Quickstart](https://qdrant.tech/documentation/edge/edge-quickstart/) ([local](./01_qdrant-edge/01_quickstart.md))| Get started with Qdrant Edge and learn the basics of managing and querying data  
**Beginner**| [On-Device Embeddings](https://qdrant.tech/documentation/edge/edge-fastembed-embeddings/) ([local](./01_qdrant-edge/02_on-device-embeddings.md))| Generate vector embeddings directly on edge devices using FastEmbed  
**Reference**| [Data Synchronization Patterns](https://qdrant.tech/documentation/edge/edge-data-synchronization-patterns/) ([local](./01_qdrant-edge/03_data-synchronization-patterns.md))| Overview of patterns for synchronizing data between Edge Shards and Qdrant server collections  
**Advanced**| [Synchronize with a Server](https://qdrant.tech/documentation/edge/edge-synchronization-guide/) ([local](./01_qdrant-edge/04_synchronize-with-a-server.md))| Synchronize an Edge Shard with a Qdrant server collection to offload indexing and synchronize data between devices  
