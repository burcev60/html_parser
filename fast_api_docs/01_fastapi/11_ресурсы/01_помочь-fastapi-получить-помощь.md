...
source: https://fastapi.tiangolo.com/ru/help-fastapi/
---
...
[Английская версия](https://fastapi.tiangolo.com/help-fastapi/)
...
Вы можете подписаться на редкую [новостную рассылку **FastAPI и его друзья**](https://fastapi.tiangolo.com/ru/newsletter/) ([local](./05_fastapi-and-friends-newsletter.md)) и быть в курсе о:
...
Если Вы много помогаете людям с их вопросами, Вы станете официальным [Экспертом FastAPI](https://fastapi.tiangolo.com/ru/fastapi-people/#fastapi-experts) ([local](./../09_fastapi-people.md#fastapi-experts)). 🎉
...
Вы можете [сделать вклад](https://fastapi.tiangolo.com/ru/contributing/) ([local](./02_development-contributing.md)) в исходный код пулл-реквестами, например:
  ...
  * Помочь с [переводом документации](https://fastapi.tiangolo.com/ru/contributing/#translations) ([local](./02_development-contributing.md#translations)) на Ваш язык.
...
По вопросам — задавайте их в [GitHub Discussions](https://github.com/fastapi/fastapi/discussions/new?category=questions), так гораздо выше шанс, что Вы получите помощь от [Экспертов FastAPI](https://fastapi.tiangolo.com/ru/fastapi-people/#fastapi-experts) ([local](./../09_fastapi-people.md#fastapi-experts)).
...
Кроме того, переписка в чатах хуже ищется, чем на GitHub, поэтому вопросы и ответы могут теряться среди остальных сообщений. И только те, что на GitHub, учитываются для получения лычки [Эксперт FastAPI](https://fastapi.tiangolo.com/ru/fastapi-people/#fastapi-experts) ([local](./../09_fastapi-people.md#fastapi-experts)), так что вероятнее всего Вы получите больше внимания именно на GitHub.
