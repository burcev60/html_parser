---
title: Шаблон Full Stack FastAPI
source: https://fastapi.tiangolo.com/ru/project-generation/
---
...
Вы можете улучшить этот перевод, [помогая нам лучше направлять ИИ LLM](https://fastapi.tiangolo.com/ru/contributing/#translations) ([local](./02_development-contributing.md#translations)).

[Английская версия](https://fastapi.tiangolo.com/project-generation/)
...
## Шаблон Full Stack FastAPI — Технологический стек и возможности
  ...
  * ⚡ [**FastAPI**](https://fastapi.tiangolo.com/ru) ([local](./../../index.md)) для бэкенд‑API на Python.
