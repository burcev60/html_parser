...
source: https://fastapi.tiangolo.com/ru/management-tasks/
---

# Repository Management Tasks

These are the tasks that can be performed to manage the FastAPI repository by [team members](https://fastapi.tiangolo.com/ru/fastapi-people/#team) ([local](./../09_fastapi-people.md#team)).

Tip

This section is useful only to a handful of people, team members with permissions to manage the repository. You can probably skip it. 😉

...so, you are a [team member of FastAPI](https://fastapi.tiangolo.com/ru/fastapi-people/#team) ([local](./../09_fastapi-people.md#team))? Wow, you are so cool! 😎

You can help with everything on [Help FastAPI - Get Help](https://fastapi.tiangolo.com/ru/help-fastapi/) ([local](./01_помочь-fastapi-получить-помощь.md)) the same ways as external contributors. But additionally, there are some tasks that only you (as part of the team) can perform.
