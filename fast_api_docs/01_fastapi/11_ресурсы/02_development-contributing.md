...
Learn more: [Contributing - Translations](https://fastapi.tiangolo.com/contributing/#translations)

First, you might want to see the basic ways to [help FastAPI and get help](https://fastapi.tiangolo.com/ru/help-fastapi/) ([local](./01_помочь-fastapi-получить-помощь.md)).
