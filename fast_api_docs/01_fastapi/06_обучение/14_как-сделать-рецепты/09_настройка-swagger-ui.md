---
title: Настройка Swagger UI
source: https://fastapi.tiangolo.com/ru/how-to/configure-swagger-ui/
---
...
[Английская версия](https://fastapi.tiangolo.com/how-to/configure-swagger-ui/)
...
## Изменить параметры Swagger UI по умолчанию
...
Если вам нужны такие настройки только для JavaScript, используйте один из методов выше. Переопределите _операцию пути_ Swagger UI и вручную напишите любой необходимый JavaScript.
