---
title: Об HTTPS
source: https://fastapi.tiangolo.com/ru/deployment/https/
---
...
[Английская версия](https://fastapi.tiangolo.com/deployment/https/)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https01.drawio.svg)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https02.drawio.svg)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https03.drawio.svg)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https04.drawio.svg)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https05.drawio.svg)

### HTTP‑ответ

Приложение обработает запрос и отправит **обычный (незашифрованный) HTTP‑ответ** прокси‑серверу TLS-терминации.

![](https://fastapi.tiangolo.com/img/deployment/https/https06.drawio.svg)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https07.drawio.svg)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https08.drawio.svg)
...
![](https://fastapi.tiangolo.com/img/deployment/https/https.drawio.svg)
...
Но вы можете настроить **сервер приложения** , чтобы он доверял _пересылаемым_ заголовкам, отправленным **прокси**. Если вы используете FastAPI CLI, вы можете использовать _опцию CLI_ `--forwarded-allow-ips`, чтобы указать, с каких IP‑адресов следует доверять этим _пересылаемым_ заголовкам.
...
Подробнее об этом вы можете узнать в документации: [За прокси — Включить пересылаемые заголовки прокси](https://fastapi.tiangolo.com/ru/advanced/behind-a-proxy/#enable-proxy-forwarded-headers) ([local](./../08_расширенное-руководство-пользователя/17_за-прокси-сервером.md#enable-proxy-forwarded-headers))
...
В некоторых из следующих глав я покажу вам несколько конкретных примеров настройки **HTTPS** для приложений **FastAPI**. 🔒
  *[SNI]: Server Name Indication - Указание имени сервера
