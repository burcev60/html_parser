---
title: FastAPI CLI
source: https://fastapi.tiangolo.com/ru/fastapi-cli/
---
...
[Английская версия](https://fastapi.tiangolo.com/fastapi-cli/)
...
## Настройте `entrypoint` приложения в `pyproject.toml`
...
Кроме того, другие инструменты могут не найти его, например [Расширение VS Code](https://fastapi.tiangolo.com/ru/editor-support/) ([local](./10_поддержка-редактора-кода.md)) или [FastAPI Cloud](https://fastapicloud.com), поэтому рекомендуется использовать `entrypoint` в `pyproject.toml`.
...
Вы можете больше узнать об этом в [документации по развертыванию](https://fastapi.tiangolo.com/ru/deployment/) ([local](./11_развёртывание.md)).
