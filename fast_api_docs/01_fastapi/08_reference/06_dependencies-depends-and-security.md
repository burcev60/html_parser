...
Read more about it in the [FastAPI docs for FastAPI Dependencies with yield](https://fastapi.tiangolo.com/tutorial/dependencies/dependencies-with-yield/#early-exit-and-scope) **TYPE:** `Literal['function', 'request'] | None` **DEFAULT:** `None`  
