---
title: Subject Mapping and Partitioning
source: https://docs.nats.io/nats-concepts/subject_mapping
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/nats-concepts/subject_mapping.md)chevron-down
...
You can easily test individual subject transform rules using the [`nats`](https://docs.nats.io/using-nats/nats-tools/nats_cli) ([local](./../_unsorted/using-nats/nats-tools/nats-cli.md)) CLI tool command `nats server mapping`. See examples below.
...
[hashtag](#mapping-a-full-wildcard-greater-than)
...
[hashtag](#subject-token-reordering)
...
[hashtag](#dropping-subject-tokens)
...
[hashtag](#splitting-on-a-separator)
...
[hashtag](#splitting-at-an-offset)
...
[hashtag](#deterministic-subject-token-partitioning)
...
[hashtag](#when-is-deterministic-partitioning-uselful)
...
[hashtag](#for-a-b-testing-or-canary-releases)
...
[hashtag](#for-traffic-shaping-in-testing)
...
[hashtag](#cluster-scoped-mappings)
...
[hashtag](#subject-mapping-and-transforms-in-streams)
...
![](https://docs.nats.io/~gitbook/image?url=https%3A%2F%2F1487470910-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-LqMYcZML1bsXrN3Ezg0%252Fuploads%252Fgit-blob-a265cee62a0bf0e0b5d4c4ec68995c9ae39ec6fe%252Fstream-transform.png%3Falt%3Dmedia%26token%3Deb61f7ba-76df-4d3a-b150-926c9af92e4d&width=768&dpr=3&quality=100&sign=5627f224&sv=2)

[PreviousHeaderschevron-left](https://docs.nats.io/nats-concepts/jetstream/headers) ([local](./../_unsorted/nats-concepts/jetstream/headers.md))[NextNATS Service Infrastructurechevron-right](https://docs.nats.io/nats-concepts/service_infrastructure) ([local](./11_nats-service-infrastructure-chevron-right.md))
