---
title: FAQ
source: https://docs.nats.io/reference/faq
---
...
block-quoteOn this pageblock-quote
  ...
  1. [Reference](https://docs.nats.io/reference) ([local](./../_unsorted/reference.md))
...
General
  ...
  * [JetStream and NATS Streaming?](#jetstream-and-nats-streaming)
...
Technical Questions
  ...
  * [Does NATS support replay/redelivery of historical data?](#does-nats-support-replay-redelivery-of-historical-data)
  ...
  * [How many clients can connect simultaneously?](#how-many-clients-can-connect-simultaneously)
...
NATS is offered in two interoperable modules in a single "NATS Server" binary (often referred to as `nats-server` throughout this site):
  ...
  * ['JetStream'](https://docs.nats.io/using-nats/developer/develop_jetstream) ([local](./../_unsorted/using-nats/developer/develop-jetstream.md)) is the (optionally enabled) built-in persistence layer that adds streaming, at-least-once and exactly-once guarantees, historical data replay, decoupled flow-control and key/value store functionalities to Core NATS.
...
As of NATS Server 2.2, NATS [JetStream](https://docs.nats.io/using-nats/developer/develop_jetstream) ([local](./../_unsorted/using-nats/developer/develop-jetstream.md)) is the recommended option for persistence, streaming and higher message guarantees. [NATS Streamingarrow-up-right](https://github.com/nats-io/nats-streaming-server) a.k.a. 'STAN' is now deprecated.
...
A more detailed overview of monitoring is available under [NATS Server Monitoring](https://docs.nats.io/running-a-nats-service/configuration/monitoring) ([local](./../_unsorted/running-a-nats-service/configuration/monitoring.md)).
...
As of NATS Server 2.2, NATS JetStream offers persistence with "at-least-once" and "exactly-once" (within a time window) delivery. See the [JetStream](https://docs.nats.io/using-nats/developer/develop_jetstream) ([local](./../_unsorted/using-nats/developer/develop-jetstream.md)) documentation for detailed information.
...
NATS [JetStream](https://docs.nats.io/using-nats/developer/develop_jetstream) ([local](./../_unsorted/using-nats/developer/develop-jetstream.md)) offers message store and replay by time or sequence.
...
[PreviousProfilingchevron-left](https://docs.nats.io/running-a-nats-service/nats_admin/profiling) ([local](./../_unsorted/running-a-nats-service/nats-admin/profiling.md))[NextNATS Protocolschevron-right](https://docs.nats.io/reference/reference-protocols) ([local](./02_nats-protocols-chevron-right.md))
