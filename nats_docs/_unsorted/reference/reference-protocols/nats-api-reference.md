---
title: JetStream wire API Reference
source: https://docs.nats.io/reference/reference-protocols/nats_api_reference
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/jetstream/nats_api_reference.md)chevron-down
...
Note that if the resources you're trying to access have a JetStream [domainarrow-up-right](https://docs.nats.io/running-a-nats-service/configuration/leafnodes/jetstream_leafnodes#leaf-nodes) ([local](./../../running-a-nats-service/configuration/leafnodes/jetstream-leafnodes.md#leaf-nodes)) associated with them, then the subject prefix will be `$JS.{domain}.API` rather than `$JS.API`.
...
[hashtag](#stream-source-and-mirror)
...
[hashtag](#heartbeats-and-retries)
...
[hashtag](#constraints-and-limitations)
...
[hashtag](#fetching-the-next-message-from-a-pull-based-consumer)
...
[hashtag](#fetching-from-a-stream-by-sequence)
...
[PreviousNATS Cluster Protocolchevron-left](https://docs.nats.io/reference/reference-protocols/nats-server-protocol) ([local](./nats-server-protocol.md))[NextRoadmapchevron-right](https://docs.nats.io/reference/roadmap) ([local](./../../../11_chevron-right/04_roadmap.md))
