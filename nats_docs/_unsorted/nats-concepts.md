---
title: Overview
source: https://docs.nats.io/nats-concepts
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/overview.md)chevron-down
...
[hashtag](#what-makes-the-nats-connective-technology-unique-for-these-modern-systems)
...
[hashtag](#scalable-future-proof-deployments)
...
[PreviousNATS 2.0chevron-left](https://docs.nats.io/release-notes/whats_new/whats_new_20) ([local](./release-notes/whats-new/whats-new-20.md))[NextCompare NATSchevron-right](https://docs.nats.io/nats-concepts/overview/compare-nats) ([local](./nats-concepts/overview/compare-nats.md))
