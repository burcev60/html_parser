...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/nats-tools/nats_cli/README.md)chevron-down
...
Check out the repo for all the details: [github.com/nats-io/natscliarrow-up-right](https://github.com/nats-io/natscli).

## 

[hashtag](#installing-nats)
...
You can read about execution policies [herearrow-up-right](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_execution_policies).

Binaries are also available as [GitHub Releasesarrow-up-right](https://github.com/nats-io/natscli/releases).
...
Getting help
  ...
  * [NATS Command Line Interface READMEarrow-up-right](https://github.com/nats-io/natscli#readme)
...
[hashtag](#managing-and-interacting-with-streams)
...
[hashtag](#managing-and-interacting-with-the-k-v-store)
...
[hashtag](#get-reference-information)
...
[hashtag](#configuration-contexts)
...
[PreviousNATS Toolschevron-left](https://docs.nats.io/using-nats/nats-tools) ([local](./../../../07_chevron-right/01_nats-tools-chevron-right.md))[Nextnats benchchevron-right](https://docs.nats.io/using-nats/nats-tools/nats_cli/natsbench) ([local](./nats-cli/natsbench.md))
