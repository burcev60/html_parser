...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/nats-tools/nsc/signing_keys.md)chevron-down
...
[hashtag](#template-functions)

Template functions

 _Available as of NATS 2.9.0_
...
[PreviousServiceschevron-left](https://docs.nats.io/using-nats/nats-tools/nsc/services) ([local](./services.md))[NextRevocationchevron-right](https://docs.nats.io/using-nats/nats-tools/nsc/revocation) ([local](./revocation.md))
