---
title: Streams
source: https://docs.nats.io/using-nats/nats-tools/nsc/streams
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/nats-tools/nsc/streams.md)chevron-down
...
[hashtag](#adding-a-public-stream-export)
...
[hashtag](#creating-a-private-stream-export)
...
[hashtag](#importing-a-private-stream)
...
[hashtag](#testing-the-private-stream)
...
[PreviousBasicschevron-left](https://docs.nats.io/using-nats/nats-tools/nsc/basics) ([local](./basics.md))[NextServiceschevron-right](https://docs.nats.io/using-nats/nats-tools/nsc/services) ([local](./services.md))
