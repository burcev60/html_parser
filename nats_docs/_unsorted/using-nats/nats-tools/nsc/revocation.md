...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/nats-tools/nsc/revocation.md)chevron-down
...
[PreviousSigning Keyschevron-left](https://docs.nats.io/using-nats/nats-tools/nsc/signing_keys) ([local](./signing-keys.md))[NextManaged Operatorschevron-right](https://docs.nats.io/using-nats/nats-tools/nsc/managed) ([local](./managed.md))
