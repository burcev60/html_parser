...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/nats-tools/nsc/services.md)chevron-down
...
[hashtag](#adding-a-public-service-export)
...
To learn how to inspect a JWT from an account server, [check this articlearrow-up-right](https://github.com/nats-io/nats.docs/blob/master/legacy/nas/inspecting_jwts.md).
...
[hashtag](#pushing-the-changes-to-the-nats-servers)
...
[hashtag](#testing-the-service)

Testing the Service

To test the service, we can install the ['nats'](https://docs.nats.io/using-nats/nats-tools/nats_cli) ([local](./../nats-cli.md)) CLI tool:
...
[hashtag](#creating-a-private-service-export)
...
[hashtag](#generating-an-activation-token)
...
[hashtag](#importing-a-private-service)
...
[hashtag](#testing-the-private-service)
...
[PreviousStreamschevron-left](https://docs.nats.io/using-nats/nats-tools/nsc/streams) ([local](./streams.md))[NextSigning Keyschevron-right](https://docs.nats.io/using-nats/nats-tools/nsc/signing_keys) ([local](./signing-keys.md))
