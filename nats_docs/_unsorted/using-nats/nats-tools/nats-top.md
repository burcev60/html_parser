...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/nats-tools/nats_top/README.md)chevron-down
...
[nats-toparrow-up-right](https://github.com/nats-io/nats-top) is a [toparrow-up-right](http://man7.org/linux/man-pages/man1/top.1.html)-like tool for monitoring nats-server servers.

circle-info

The `nats-top` functionality is now available in the [`nats`arrow-up-right](https://github.com/nats-io/nats.docs/blob/master/using-nats/nats-tools/using-nats/nats-tools/nats_cli/README.md) CLI tool using the `nats top` command.
...
For a walkthrough with `nats-top` check out the [tutorial](https://docs.nats.io/using-nats/nats-tools/nats_top/nats-top-tutorial) ([local](./nats-top/nats-top-tutorial.md)).

[PreviousManaged Operatorschevron-left](https://docs.nats.io/using-nats/nats-tools/nsc/managed) ([local](./nsc/managed.md))[NextTutorialchevron-right](https://docs.nats.io/using-nats/nats-tools/nats_top/nats-top-tutorial) ([local](./nats-top/nats-top-tutorial.md))
