---
title: Advanced Connect and Custom Dialer in Go
source: https://docs.nats.io/using-nats/developer/tutorials/custom_dialer
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/tutorials/custom_dialer.md)chevron-down
...
[PreviousTutorialschevron-left](https://docs.nats.io/using-nats/developer/tutorials) ([local](./../tutorials.md))[NextInstalling, running and deploying a NATS Serverchevron-right](https://docs.nats.io/running-a-nats-service/introduction) ([local](./../../../../09_chevron-right/01_installing-running-and-deploying-a-nats-server-chevron-right.md))
