---
title: JetStream
source: https://docs.nats.io/using-nats/developer/develop_jetstream
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/jetstream/develop_jetstream.md)chevron-down
...
[hashtag](#deciding-to-use-streaming-and-higher-qualities-of-service)
...
[hashtag](#jetstream-functionality-overview)
...
See Also
  ...
  * [Sync and Async JetStream publishing in Javaarrow-up-right](https://nats.io/blog/sync-async-publish-java-client/#synchronous-and-asynchronous-publishing-with-the-nats-java-library)

### 

[hashtag](#create-a-consumer)

Create a consumer

[Consumers](https://docs.nats.io/nats-concepts/jetstream/consumers) ([local](./../../nats-concepts/jetstream/consumers.md)) are 'views' into a stream, with their own cursor. They are how client applications get messages from a stream (i.e. 'replayed') for processing or consumption. They can filter messages in the stream according to a 'filtering subject' and define which part of the stream is replayed according to a 'replay policy'.

You can create _push_ or _pull_ consumers:

  * _Push_ consumers (specifically ordered push consumers) are the best way for an application to receive its own complete copy of the selected messages in the stream.

  * _Pull_ consumers are the best way to scale horizontally the processing (or consuming) of the selected messages in the stream using multiple client applications sharing the same pull consumer, and allow for the processing of messages in batches.
...
See Also
  ...
  * Java
    ...
    * [JetStream Java tutorialarrow-up-right](https://nats.io/blog/hello-world-java-client/)

    * [JetStream stream creation in Javaarrow-up-right](https://nats.io/blog/jetstream-java-client-01-stream-create/)

    * [JetStream publishing in Javaarrow-up-right](https://nats.io/blog/jetstream-java-client-02-publish/)

    * [Consumers in Javaarrow-up-right](https://nats.io/blog/jetstream-java-client-03-consume/)

    * [Push consumers in Javaarrow-up-right](https://nats.io/blog/jetstream-java-client-04-push-subscribe/#jetstream-push-consumers-with-the-natsio-java-library)

    * [Pull consumers in Javaarrow-up-right](https://nats.io/blog/jetstream-java-client-05-pull-subscribe/#jetstream-pull-consumers-with-the-natsio-java-library)

[PreviousBuilding Serviceschevron-left](https://docs.nats.io/using-nats/developer/services) ([local](./services.md))[NextJetStream Model Deep Divechevron-right](https://docs.nats.io/using-nats/developer/develop_jetstream/model_deep_dive) ([local](./develop-jetstream/model-deep-dive.md))
