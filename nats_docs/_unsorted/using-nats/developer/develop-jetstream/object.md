---
title: Using the Object Store
source: https://docs.nats.io/using-nats/developer/develop_jetstream/object
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/js/object.md)chevron-down
...
See more at [jetstream/object.goarrow-up-right](https://github.com/nats-io/nats.go/blob/main/jetstream/object.go)
...
[PreviousUsing the Key/Value Storechevron-left](https://docs.nats.io/using-nats/developer/develop_jetstream/kv) ([local](./kv.md))[NextTutorialschevron-right](https://docs.nats.io/using-nats/developer/tutorials) ([local](./../tutorials.md))
