---
title: Managing Streams and consumers
source: https://docs.nats.io/using-nats/developer/develop_jetstream/streams
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/js/streams.md)chevron-down
...
[PreviousJetStream Model Deep Divechevron-left](https://docs.nats.io/using-nats/developer/develop_jetstream/model_deep_dive) ([local](./model-deep-dive.md))[NextConsumer Detailschevron-right](https://docs.nats.io/using-nats/developer/develop_jetstream/consumers) ([local](./consumers.md))
