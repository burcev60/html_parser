...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/jetstream/model_deep_dive.md)chevron-down
...
block-quoteOn this pageblock-quote
  ...
  3. [JetStream](https://docs.nats.io/using-nats/developer/develop_jetstream) ([local](./../develop-jetstream.md))

# JetStream Model Deep Dive

## 

[hashtag](#stream-limits-retention-and-policy)
...
[hashtag](#acknowledgement-models)
...
(2.14) Messages are acknowledged based on flow control. Primarily used for stream sourcing/mirroring using a durable consumer
...
[hashtag](#consumer-starting-position)
...
[hashtag](#consumer-message-rates)
...
Consumers can sample Ack'ed messages for you and publish samples so your monitoring system can observe the health of a Consumer. We will add support for this to [NATS Surveyorarrow-up-right](https://github.com/nats-io/nats-surveyor).
...
[PreviousJetStreamchevron-left](https://docs.nats.io/using-nats/developer/develop_jetstream) ([local](./../develop-jetstream.md))[NextManaging Streams and consumerschevron-right](https://docs.nats.io/using-nats/developer/develop_jetstream/streams) ([local](./streams.md))
