...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/js/publish.md)chevron-down
...
[PreviousConsumer Detailschevron-left](https://docs.nats.io/using-nats/developer/develop_jetstream/consumers) ([local](./consumers.md))[NextUsing the Key/Value Storechevron-right](https://docs.nats.io/using-nats/developer/develop_jetstream/kv) ([local](./kv.md))
