...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/js/kv.md)chevron-down
...
As the Key Value Store is built on top of the JetStream persistence layer you obtain a KeyValueManager object from your JetStream [contextarrow-up-right](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/js/context.md).

The key must be in the same format as a NATS subject, i.e. it can be a dot separated list of tokens (which means that you can then use wildcards to match hierarchies of keys when watching a bucket), and can only contain [valid characters](https://docs.nats.io/nats-concepts/subjects#characters-allowed-for-subject-names) ([local](./../../../../05_chevron-right/05_subject-based-messaging.md#characters-allowed-for-subject-names)). The value can be any byte array.

### 

[hashtag](#creating-and-deleting-kv-buckets)
...
[hashtag](#getting-the-history-for-a-key)
...
[PreviousPublishing to Streamschevron-left](https://docs.nats.io/using-nats/developer/develop_jetstream/publish) ([local](./publish.md))[NextUsing the Object Storechevron-right](https://docs.nats.io/using-nats/developer/develop_jetstream/object) ([local](./object.md))
