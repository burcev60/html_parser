---
title: Miscellaneous functionalities
source: https://docs.nats.io/using-nats/developer/connecting/misc
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/connecting/misc.md)chevron-down
...
[hashtag](#turn-on-pedantic-mode)

Turn On Pedantic Mode

The NATS server provides a _pedantic_ mode that performs extra checks on the protocol.

One example of such a check is if a subject used for publishing contains a [wildcard](https://docs.nats.io/nats-concepts/subjects#wildcards) ([local](./../../../../05_chevron-right/05_subject-based-messaging.md#wildcards)) character. The server will not use it as wildcard and therefore omits this check.
...
[hashtag](#turn-on-off-verbose-mode)
...
[PreviousTurning Off Echo'd Messageschevron-left](https://docs.nats.io/using-nats/developer/connecting/noecho) ([local](./noecho.md))[NextAutomatic Reconnectionschevron-right](https://docs.nats.io/using-nats/developer/connecting/reconnect) ([local](./reconnect.md))
