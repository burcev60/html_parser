...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/connecting/cluster.md)chevron-down
...
[PreviousConnecting to a Specific Serverchevron-left](https://docs.nats.io/using-nats/developer/connecting/specific_server) ([local](./specific-server.md))[NextConnection Namechevron-right](https://docs.nats.io/using-nats/developer/connecting/name) ([local](./name.md))
