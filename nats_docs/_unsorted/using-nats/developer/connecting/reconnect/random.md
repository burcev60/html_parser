...
source: https://docs.nats.io/using-nats/developer/connecting/reconnect/random
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/reconnect/random.md)chevron-down
...
[PreviousSet the Number of Reconnect Attemptschevron-left](https://docs.nats.io/using-nats/developer/connecting/reconnect/max) ([local](./max.md))[NextPausing Between Reconnect Attemptschevron-right](https://docs.nats.io/using-nats/developer/connecting/reconnect/wait) ([local](./wait.md))
