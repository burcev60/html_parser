---
title: Listening for Reconnect Events
source: https://docs.nats.io/using-nats/developer/connecting/reconnect/events
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/reconnect/events.md)chevron-down
...
[PreviousPausing Between Reconnect Attemptschevron-left](https://docs.nats.io/using-nats/developer/connecting/reconnect/wait) ([local](./wait.md))[NextBuffering Messages During Reconnect Attemptschevron-right](https://docs.nats.io/using-nats/developer/connecting/reconnect/buffer) ([local](./buffer.md))
