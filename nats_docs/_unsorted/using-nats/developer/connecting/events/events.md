---
title: Listen for Connection Events
source: https://docs.nats.io/using-nats/developer/connecting/events/events
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/events/events.md)chevron-down
...
[hashtag](#listen-for-new-servers)
...
[PreviousMonitoring the Connectionchevron-left](https://docs.nats.io/using-nats/developer/connecting/events) ([local](./../events.md))[NextSlow Consumerschevron-right](https://docs.nats.io/using-nats/developer/connecting/events/slow) ([local](./slow.md))
