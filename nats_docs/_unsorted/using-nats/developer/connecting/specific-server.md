---
title: Connecting to a Specific Server
source: https://docs.nats.io/using-nats/developer/connecting/specific_server
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/connecting/specific_server.md)chevron-down
...
[PreviousConnecting to the Default Serverchevron-left](https://docs.nats.io/using-nats/developer/connecting/default_server) ([local](./default-server.md))[NextConnecting to a Clusterchevron-right](https://docs.nats.io/using-nats/developer/connecting/cluster) ([local](./cluster.md))
