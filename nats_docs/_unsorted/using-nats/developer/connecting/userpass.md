...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/connecting/security/userpass.md)chevron-down
...
You can encrypt passwords to pass to `nats-server` using the simple [NATS CLI tool:](https://docs.nats.io/using-nats/nats-tools/nats_cli) ([local](./../../nats-tools/nats-cli.md))
...
[hashtag](#connecting-with-a-user-password)
...
[hashtag](#connecting-with-a-user-password-in-the-url)
...
[PreviousConnection Namechevron-left](https://docs.nats.io/using-nats/developer/connecting/name) ([local](./name.md))[NextAuthenticating with a Tokenchevron-right](https://docs.nats.io/using-nats/developer/connecting/token) ([local](./token.md))
