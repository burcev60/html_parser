---
title: Receiving Structured Data
source: https://docs.nats.io/using-nats/developer/receiving/structure
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/receiving/structure.md)chevron-down
...
[PreviousDraining Messages Before Disconnectchevron-left](https://docs.nats.io/using-nats/developer/receiving/drain) ([local](./drain.md))[NextSending Messageschevron-right](https://docs.nats.io/using-nats/developer/sending) ([local](./../sending.md))
