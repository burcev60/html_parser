---
title: Draining Messages Before Disconnect
source: https://docs.nats.io/using-nats/developer/receiving/drain
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/receiving/drain.md)chevron-down
...
[PreviousQueue Subscriptionschevron-left](https://docs.nats.io/using-nats/developer/receiving/queues) ([local](./queues.md))[NextReceiving Structured Datachevron-right](https://docs.nats.io/using-nats/developer/receiving/structure) ([local](./structure.md))
