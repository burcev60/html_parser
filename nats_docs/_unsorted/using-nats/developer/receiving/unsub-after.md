---
title: Unsubscribing After N Messages
source: https://docs.nats.io/using-nats/developer/receiving/unsub_after
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/receiving/unsub_after.md)chevron-down
...
[PreviousUnsubscribingchevron-left](https://docs.nats.io/using-nats/developer/receiving/unsubscribing) ([local](./unsubscribing.md))[NextReplying to a Messagechevron-right](https://docs.nats.io/using-nats/developer/receiving/reply) ([local](./reply.md))
