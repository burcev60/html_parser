---
title: Sending Structured Data
source: https://docs.nats.io/using-nats/developer/sending/structure
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/using-nats/developing-with-nats/sending/structure.md)chevron-down
...
[PreviousCaches, Flush and Pingchevron-left](https://docs.nats.io/using-nats/developer/sending/caches) ([local](./caches.md))[NextBuilding Serviceschevron-right](https://docs.nats.io/using-nats/developer/services) ([local](./../services.md))
