---
title: What's New!
source: https://docs.nats.io/release-notes
---
...
Check out the:
  ...
  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_214) ([local](./release-notes/whats-new/whats-new-214.md))
...
Check out the:
  ...
  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_212) ([local](./release-notes/whats-new/whats-new-212.md))
...
Check out the:
  ...
  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_211) ([local](./release-notes/whats-new/whats-new-211.md))
...
Check out the:
  ...
  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_210) ([local](./release-notes/whats-new/whats-new-210.md))
...
Server release v2.3.0
  ...
  * [OCSP support](https://docs.nats.io/running-a-nats-service/configuration/securing_nats/ocsp) ([local](./running-a-nats-service/configuration/securing-nats/ocsp.md))
...
See [NATS 2.2](https://docs.nats.io/release-notes/whats_new/whats_new_22) ([local](./release-notes/whats-new/whats-new-22.md)) for new features.
...
For more information on monitoring endpoints see [NATS Server Configurations System Events](https://docs.nats.io/running-a-nats-service/configuration/sys_accounts) ([local](./running-a-nats-service/configuration/sys-accounts.md)).
...
For more information and examples, see [Securing NATS](https://docs.nats.io/running-a-nats-service/configuration/securing_nats) ([local](./running-a-nats-service/configuration/securing-nats.md))
...
`trace_verbose` and command line parameters `-VV` and `-DVV` added. See [NATS Logging Configuration](https://docs.nats.io/running-a-nats-service/configuration/logging#configuring-logging) ([local](./running-a-nats-service/configuration/logging.md#configuring-logging))
...
More information on Queue Permissions can be found in the [Developing with NATS](https://docs.nats.io/using-nats/developer/receiving/queues) ([local](./using-nats/developer/receiving/queues.md)) section.
...
[PreviousWelcomechevron-left](https://docs.nats.io/) ([local](./../index.md))[NextNATS 2.14chevron-right](https://docs.nats.io/release-notes/whats_new/whats_new_214) ([local](./release-notes/whats-new/whats-new-214.md))
