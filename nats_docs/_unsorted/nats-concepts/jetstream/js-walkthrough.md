---
title: JetStream Walkthrough
source: https://docs.nats.io/nats-concepts/jetstream/js_walkthrough
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/nats-concepts/jetstream/js_walkthrough.md)chevron-down
...
The following is a small walkthrough on creating a stream and a consumer and interacting with the stream using the [nats cliarrow-up-right](https://github.com/nats-io/natscli).

## 

[hashtag](#prerequisite-enabling-jetstream)
...
[hashtag](#id-1.-creating-a-stream)
...
[hashtag](#id-2.-publish-some-messages-into-the-stream)
...
[hashtag](#id-3.-creating-a-consumer)
...
[hashtag](#id-3.-subscribing-from-the-consumer)
...
[hashtag](#replaying-the-messages-again)
...
[PreviousExamplechevron-left](https://docs.nats.io/nats-concepts/jetstream/consumers/example_configuration) ([local](./consumers/example-configuration.md))[NextKey/Value Storechevron-right](https://docs.nats.io/nats-concepts/jetstream/key-value-store) ([local](./../../../14_hashtag-guided-tour/02_kv.md))
