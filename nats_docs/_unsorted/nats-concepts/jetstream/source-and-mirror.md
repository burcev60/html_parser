---
title: Source and Mirror Streams
source: https://docs.nats.io/nats-concepts/jetstream/source_and_mirror
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/nats-concepts/jetstream/source_and_mirror.md)chevron-down
...
circle-info
  ...
  * Mirrors can be used for for (geographic) load distribution with the `MirrorDirect` stream attribute. See: <https://docs.nats.io/nats-concepts/jetstream/streams#configuration> ([local](./streams.md#configuration))[arrow-up-right](https://docs.nats.io/nats-concepts/jetstream/streams#configuration) ([local](./streams.md#configuration))

## 

[hashtag](#expected-behavior-in-edge-conditions)
...
[hashtag](#workqueue-interest-retention)
...
[hashtag](#bring-your-own-sourcing-consumer)
...
[PreviousStreamschevron-left](https://docs.nats.io/nats-concepts/jetstream/streams) ([local](./streams.md))[NextExamplechevron-right](https://docs.nats.io/nats-concepts/jetstream/source_and_mirror/source_and_mirror_example) ([local](./source-and-mirror/source-and-mirror-example.md))
