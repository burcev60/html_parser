...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/nats-concepts/overview/compare-nats.md)chevron-down

block-quoteOn this pageblock-quote

  1. [NATS Concepts](https://docs.nats.io/nats-concepts) ([local](./../../nats-concepts.md))chevron-right
  2. [Overview](https://docs.nats.io/nats-concepts/overview) ([local](./../../../05_chevron-right/01_overview-chevron-right.md))
...
[hashtag](#language-and-platform-coverage)
...
[hashtag](#multi-tenancy-and-sharing)
...
[hashtag](#message-retention-and-persistence)
...
[hashtag](#high-availability-and-fault-tolerance)
...
Kafka supports clustering with mirroring to loosely coupled remote clusters. Clients are tied to partitions defined within clusters. Kafka servers require a JVM, eight cores, 64 GB to128 GB of RAM, two or more 8-TB SAS/SSD disks, and a 10-Gig NIC. [_(1)_](#references) __
...
NATS supports WebSockets, a Kafka bridge, an IBM MQ Bridge, a Redis Connector, Apache Spark, Apache Flink, CoreOS, Elastic, Elasticsearch, Prometheus, Telegraf, Logrus, Fluent Bit, Fluentd, OpenFAAS, HTTP, and MQTT, and [morearrow-up-right](https://nats.io/download/#connectors-and-utilities).

**gRPC**

There are a number of third party integrations including HTTP, JSON, Prometheus, Grift and others. [_(3)_](#references) __
...
References
  ...
  1. <https://docs.cloudera.com/HDPDocuments/HDF3/HDF-3.1.0/bk_planning-your-deployment/content/ch_hardware-sizing.html>[arrow-up-right](https://docs.cloudera.com/HDPDocuments/HDF3/HDF-3.1.0/bk_planning-your-deployment/content/ch_hardware-sizing.html)

  2. <https://pulsar.apache.org/docs/4.0.x/deploy-bare-metal/>[arrow-up-right](https://pulsar.apache.org/docs/4.0.x/deploy-bare-metal/)

  3. <https://github.com/grpc-ecosystem>[arrow-up-right](https://github.com/grpc-ecosystem)

[PreviousOverviewchevron-left](https://docs.nats.io/nats-concepts/overview) ([local](./../../../05_chevron-right/01_overview-chevron-right.md))[NextWhat is NATSchevron-right](https://docs.nats.io/nats-concepts/what-is-nats) ([local](./../../../05_chevron-right/03_what-is-nats-chevron-right.md))
