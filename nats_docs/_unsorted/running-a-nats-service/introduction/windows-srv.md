...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/running/windows_srv.md)chevron-down
...
For a complete list of signals, see [process signaling](https://docs.nats.io/running-a-nats-service/nats_admin/signals) ([local](./../nats-admin/signals.md)).
...
[hashtag](#windows-service-specific-settings)

Windows Service Specific Settings

## 

[hashtag](#windows-service-specific-settings-1)

Windows Service Specific Settings

### 

[hashtag](#nats_startup_delay-environment-variable)
...
[PreviousRunning and deploying a NATS Serverchevron-left](https://docs.nats.io/running-a-nats-service/introduction/running) ([local](./running.md))[NextFlagschevron-right](https://docs.nats.io/running-a-nats-service/introduction/flags) ([local](./flags.md))
