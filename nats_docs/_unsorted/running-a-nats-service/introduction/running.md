---
title: Running and deploying a NATS Server
source: https://docs.nats.io/running-a-nats-service/introduction/running
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/running/README.md)chevron-down
...
[hashtag](#running-nats-server-as-a-systemd-service-on-linux)
...
Please see the example files located in the `util` directory of the [nats-server repoarrow-up-right](https://github.com/nats-io/nats-server/tree/main/util) that you can use to generate your own `/etc/systemd/system/nats.service` file.
...
Normally JetStream will be run in clustered mode and will replicate data, so the best place to store JetStream data would be locally on a fast SSD. One should specifically avoid NAS or NFS storage for JetStream. More information on [containerized NATS is available here](https://docs.nats.io/running-a-nats-service/nats_docker) ([local](./../../../09_chevron-right/04_nats-and-docker-chevron-right.md)).

[PreviousInstalling a NATS Serverchevron-left](https://docs.nats.io/running-a-nats-service/introduction/installation) ([local](./installation.md))[NextWindows Servicechevron-right](https://docs.nats.io/running-a-nats-service/introduction/windows_srv) ([local](./windows-srv.md))
