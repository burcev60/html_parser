...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/configuration/websocket/websocket_conf.md)chevron-down
...
block-quoteOn this pageblock-quote
  ...
  3. [WebSocket](https://docs.nats.io/running-a-nats-service/configuration/websocket) ([local](./../websocket.md))
...
[hashtag](#authorization-of-websocket-users)
...
You can get some more information about how applications connecting over WebSocket can use those different forms of authentication [herearrow-up-right](https://github.com/nats-io/nats.ws#authentication)

### 

[hashtag](#restricting-connection-types)
...
[hashtag](#leaf-nodes-connections)

Leaf nodes connections

You can configure remote Leaf node connections so that they connect to the Websocket port instead of the Leaf node port. See [Leafnode](https://docs.nats.io/running-a-nats-service/configuration/leafnodes/leafnode_conf#connecting-using-websocket-protocol) ([local](./../leafnodes/leafnode-conf.md#connecting-using-websocket-protocol)) section.
...
[PreviousWebSocketchevron-left](https://docs.nats.io/running-a-nats-service/configuration/websocket) ([local](./../websocket.md))[NextManaging and Monitoring your NATS Server Infrastructurechevron-right](https://docs.nats.io/running-a-nats-service/nats_admin) ([local](./../../../../09_chevron-right/10_managing-and-monitoring-your-nats-server-infrastructure-chev.md))
