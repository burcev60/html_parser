---
title: Super-cluster with Gateways
source: https://docs.nats.io/running-a-nats-service/configuration/gateways
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/configuration/gateways/README.md)chevron-down
...
[hashtag](#gateway-configuration)

Gateway Configuration

The [Gateway Configuration](https://docs.nats.io/running-a-nats-service/configuration/gateways/gateway) ([local](./gateways/gateway.md)) document describes all the options available to gateways.

[PreviousTroubleshootingchevron-left](https://docs.nats.io/running-a-nats-service/configuration/clustering/jetstream_clustering/troubleshooting) ([local](./clustering/jetstream-clustering/troubleshooting.md))[NextConfigurationchevron-right](https://docs.nats.io/running-a-nats-service/configuration/gateways/gateway) ([local](./gateways/gateway.md))
