...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/configuration/clustering/README.md)chevron-down
...
[hashtag](#nats-server-clustering)
...
NATS servers achieve this by gossiping about and connecting to, all of the servers they know, thus dynamically forming a full mesh. Once clients [connect](https://docs.nats.io/using-nats/developer/connecting/cluster) ([local](./../../using-nats/developer/connecting/cluster.md)) or [re-connect](https://docs.nats.io/using-nats/developer/connecting/reconnect) ([local](./../../using-nats/developer/connecting/reconnect.md)) to a particular server, they are informed about current cluster members. Because of this behavior, a cluster can grow, shrink and self heal. The full mesh does not necessarily have to be explicitly configured either.
...
Clustering can also be configured using the server [config file](https://docs.nats.io/running-a-nats-service/configuration/clustering/cluster_config) ([local](./clustering/cluster-config.md)).

## 

[hashtag](#three-server-cluster-example)
...
[PreviousKubernetes Controllerchevron-left](https://docs.nats.io/running-a-nats-service/configuration/resource_management/configuration_mgmt/kubernetes_controller) ([local](./resource-management/configuration-mgmt/kubernetes-controller.md))[NextClustering Configurationchevron-right](https://docs.nats.io/running-a-nats-service/configuration/clustering/cluster_config) ([local](./clustering/cluster-config.md))
