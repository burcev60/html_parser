---
title: MQTT
source: https://docs.nats.io/running-a-nats-service/configuration/mqtt
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/configuration/mqtt/README.md)chevron-down
...
NATS follows as closely as possible to the MQTT v3.1.1 [specificationarrow-up-right](https://docs.oasis-open.org/mqtt/mqtt/v3.1.1/os/mqtt-v3.1.1-os.html). Refer to the [MQTT implementation overviewarrow-up-right](https://github.com/nats-io/nats-server/blob/main/server/README-MQTT.md) in the nats-server repo.

NATS supports MQTT QoS: 0, 1 and 2

## 

[hashtag](#when-to-use-mqtt)
...
[hashtag](#jetstream-requirements)
...
[hashtag](#mqtt-topics-and-nats-subjects)
...
[hashtag](#communication-between-mqtt-and-nats)
...
[hashtag](#qos-1-and-2-redeliveries)
...
[hashtag](#connections-with-same-client-id)
...
[Replace your MQTT Broker with NATS Serverarrow-up-right](https://nats.io/blog/replace-your-mqtt-broker-with-nats/)

[PreviousEnabling Monitoringchevron-left](https://docs.nats.io/running-a-nats-service/configuration/monitoring) ([local](./monitoring.md))[NextConfigurationchevron-right](https://docs.nats.io/running-a-nats-service/configuration/mqtt/mqtt_config) ([local](./mqtt/mqtt-config.md))
