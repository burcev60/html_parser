---
title: JetStream on Leaf Nodes
source: https://docs.nats.io/running-a-nats-service/configuration/leafnodes/jetstream_leafnodes
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/configuration/leafnodes/jetstream_leafnodes.md)chevron-down
...
If you want to see a demonstration of the full range of this functionality, check out our [videoarrow-up-right](https://youtu.be/0MkS_S7lyHk)

One of the use cases for a NATS server configured as a [leaf node](https://docs.nats.io/running-a-nats-service/configuration/leafnodes) ([local](./../leafnodes.md)) is to provide a local NATS network even when the connection to a hub or the cloud is down. To support such a disconnected use case with JetStream, independent JetStream islands are also supported and available through the same NATS network.
...
[hashtag](#accounts.conf-imported-by-both-servers)
...
[hashtag](#copying-across-domains-via-source-or-mirror)
...
[hashtag](#cross-account-and-domain-import)
...
[JetStream Leaf Nodes demoarrow-up-right](https://github.com/nats-io/jetstream-leaf-nodes-demo) and its companion [video recordingarrow-up-right](https://www.youtube.com/watch?v=0MkS_S7lyHk).

[PreviousConfigurationchevron-left](https://docs.nats.io/running-a-nats-service/configuration/leafnodes/leafnode_conf) ([local](./leafnode-conf.md))[NextSecuring NATSchevron-right](https://docs.nats.io/running-a-nats-service/configuration/securing_nats) ([local](./../securing-nats.md))
