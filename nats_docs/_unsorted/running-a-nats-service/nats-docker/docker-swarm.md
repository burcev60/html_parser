...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/running/nats_docker/docker_swarm.md)chevron-down
...
[PreviousTutorialchevron-left](https://docs.nats.io/running-a-nats-service/nats_docker/nats-docker-tutorial) ([local](./nats-docker-tutorial.md))[NextPython and NGS Running in Dockerchevron-right](https://docs.nats.io/running-a-nats-service/nats_docker/ngs-docker-python) ([local](./ngs-docker-python.md))
