...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/running/nats_docker/nats-docker-tutorial.md)chevron-down
...
In this tutorial you run the [NATS server Docker imagearrow-up-right](https://hub.docker.com/_/nats/). The Docker image provides an instance of the NATS Server. Synadia actively maintains and supports the nats-server Docker image. The NATS image is only 6 MB in size.

**1\. Set up Docker.**

See [Get Started with Dockerarrow-up-right](http://docs.docker.com/mac/started/) for guidance.

The easiest way to run Docker is to use the [Docker Toolboxarrow-up-right](http://docs.docker.com/mac/step_one/).
...
[PreviousNATS and Dockerchevron-left](https://docs.nats.io/running-a-nats-service/nats_docker) ([local](./../../../09_chevron-right/04_nats-and-docker-chevron-right.md))[NextDocker Swarmchevron-right](https://docs.nats.io/running-a-nats-service/nats_docker/docker_swarm) ([local](./docker-swarm.md))
