...
source: https://docs.nats.io/running-a-nats-service/nats_admin/slow_consumers
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/nats_admin/slow_consumers.md)chevron-down
...
[hashtag](#slow-consumers-identified-by-the-server)
...
[PreviousUpgrading a Clusterchevron-left](https://docs.nats.io/running-a-nats-service/nats_admin/upgrading_cluster) ([local](./upgrading-cluster.md))[NextSignalschevron-right](https://docs.nats.io/running-a-nats-service/nats_admin/signals) ([local](./signals.md))
