---
title: Monitoring JetStream
source: https://docs.nats.io/running-a-nats-service/nats_admin/monitoring/monitoring_jetstream
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/nats_admin/monitoring/monitoring_jetstream.md)chevron-down
...
block-quoteOn this pageblock-quote
  ...
  3. [Monitoring](https://docs.nats.io/running-a-nats-service/nats_admin/monitoring) ([local](./../monitoring.md))
...
If you want a "batteries-included" approach to high-cardinality NATS monitoring and observability, including JetStream streams and consumers, try the standalone [Synadia Insightsarrow-up-right](https://www.synadia.com/insights).

## 

[hashtag](#server-metrics)

Server Metrics

JetStream has a /[jsz ](https://docs.nats.io/running-a-nats-service/configuration/monitoring#jetstream-information) ([local](./../../configuration/monitoring.md#jetstream-information))HTTP endpoint and advisories available.
...
The command `nats event --js-advisory` can view all these events on your console. The Golang package [jsm.goarrow-up-right](https://github.com/nats-io/jsm.go) can consume and render these events and have data types for each of these events.
...
Check out [NATS Surveyor Dashboardsarrow-up-right](https://github.com/nats-io/nats-surveyor/tree/main/docker-compose/grafana/provisioning/dashboards).

[PreviousMonitoringchevron-left](https://docs.nats.io/running-a-nats-service/nats_admin/monitoring) ([local](./../monitoring.md))[NextManaging JetStreamchevron-right](https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin) ([local](./../jetstream-admin.md))
