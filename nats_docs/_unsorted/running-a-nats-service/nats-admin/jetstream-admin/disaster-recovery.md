...
source: https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin/disaster_recovery
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/nats_admin/jetstream_admin/disaster_recovery.md)chevron-down
...
[hashtag](#account-level-backup-and-restore)
...
Include consumer configuration and state
...
Force overwrite of existing backup directory

`--critical-warnings`

Treat warnings as critical errors

### 

[hashtag](#account-restore)
...
Target cluster for restored streams

`--tag`

Placement tag for restored streams
...
[PreviousData Replicationchevron-left](https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin/replication) ([local](./replication.md))[NextEncryption at Restchevron-right](https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin/encryption_at_rest) ([local](./encryption-at-rest.md))
