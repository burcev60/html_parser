...
[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/nats_admin/jetstream_admin/consumers.md)chevron-down
...
[hashtag](#creating-pull-based-consumers)
...
[hashtag](#creating-push-based-consumers)
...
[hashtag](#stream-vs-consumer-sequence-numbers)
...
[hashtag](#consuming-pull-based-consumers)
...
[hashtag](#consuming-push-based-consumers)
...
[PreviousStreamschevron-left](https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin/streams) ([local](./streams.md))[NextData Replicationchevron-right](https://docs.nats.io/running-a-nats-service/nats_admin/jetstream_admin/replication) ([local](./replication.md))
