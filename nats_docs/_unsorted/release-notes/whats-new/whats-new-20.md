---
title: NATS 2.0
source: https://docs.nats.io/release-notes/whats_new/whats_new_20
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/release_notes/whats_new_20.md)chevron-down
...
[hashtag](#decentralized-security)

Decentralized Security

### 

[hashtag](#operators-accounts-and-users)
...
PKI (NKeys encoded [Ed25519arrow-up-right](https://ed25519.cr.yp.to/)) and signed JWTs create a hierarchy of Operators, Accounts, and Users creating a scalable and flexible distributed security mechanism.
...
[PreviousNATS 2.2chevron-left](https://docs.nats.io/release-notes/whats_new/whats_new_22) ([local](./whats-new-22.md))[NextOverviewchevron-right](https://docs.nats.io/nats-concepts/overview) ([local](./../../../05_chevron-right/01_overview-chevron-right.md))
