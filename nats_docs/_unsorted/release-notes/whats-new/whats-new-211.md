---
title: NATS 2.11
source: https://docs.nats.io/release-notes/whats_new/whats_new_211
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/release_notes/whats_new_211.md)chevron-down
...
Streams
  ...
  * **JetStream per-message TTLs:** It is now possible to age out individual messages using a per-message TTL. The `Nats-TTL` header, in either string or integer format (in seconds) allows for individual message expiration independent of stream limits. This can be combined with other limits in place on the stream. More information is available in [ADR-43arrow-up-right](https://github.com/nats-io/nats-architecture-and-design/blob/main/adr/ADR-43.md).
...
[hashtag](#stream-ingest-rate-limiting)
...
[hashtag](#replicated-delete-proposals)
...
[hashtag](#server-cluster-and-gateway-names)
...
[PreviousNATS 2.12chevron-left](https://docs.nats.io/release-notes/whats_new/whats_new_212) ([local](./whats-new-212.md))[NextNATS 2.10chevron-right](https://docs.nats.io/release-notes/whats_new/whats_new_210) ([local](./whats-new-210.md))
