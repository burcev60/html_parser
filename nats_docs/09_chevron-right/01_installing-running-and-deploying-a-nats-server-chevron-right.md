---
title: Installing, running and deploying a NATS Server
source: https://docs.nats.io/running-a-nats-service/introduction
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/introduction.md)chevron-down
...
Even better, if you have build your application with NATS you don't need to run your own server, cluster, or super-cluster and can simply leverage Synadia's [NGSarrow-up-right](https://www.synadia.com/cloud), the global NATS super-cluster service provided by [Synadiaarrow-up-right](https://www.synadia.com?utm_source=nats_docs&utm_medium=nats).

This section of the documentation explains how to install, deploy, run, configure, orchestrate, test and manage NATS servers.

[PreviousAdvanced Connect and Custom Dialer in Gochevron-left](https://docs.nats.io/using-nats/developer/tutorials/custom_dialer) ([local](./../_unsorted/using-nats/developer/tutorials/custom-dialer.md))[NextInstalling a NATS Serverchevron-right](https://docs.nats.io/running-a-nats-service/introduction/installation) ([local](./../_unsorted/running-a-nats-service/introduction/installation.md))
