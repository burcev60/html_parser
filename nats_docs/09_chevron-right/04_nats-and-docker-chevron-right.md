---
title: NATS and Docker
source: https://docs.nats.io/running-a-nats-service/nats_docker
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/running-a-nats-service/running/nats_docker/README.md)chevron-down
...
[hashtag](#nats-server-containerization)

NATS Server Containerization

The NATS server is provided as a Docker image on [Docker Hubarrow-up-right](https://hub.docker.com/_/nats/) that you can run using the Docker daemon. The NATS server Docker image is extremely lightweight, coming in under 10 MB in size.

[Synadiaarrow-up-right](https://www.synadia.com?utm_source=nats_docs&utm_medium=nats) actively maintains and supports the NATS server Docker image.
...
The nightly build container can be found [herearrow-up-right](https://hub.docker.com/r/synadia/nats-server)
...
[hashtag](#creating-a-nats-cluster)
...
**NOTE** Since the Docker image protects routes using credentials we need to provide them above. Extracted [from Docker image configurationarrow-up-right](https://github.com/nats-io/nats-docker/blob/6fb8c05311bb4d1554390f66abb0a5ebef1e1c9d/2.1.0/scratch/amd64/nats-server.conf#L13-L19)
...
[hashtag](#creating-a-nats-cluster-with-docker-compose)
...
See the [NATS Docker tutorial](https://docs.nats.io/running-a-nats-service/nats_docker/nats-docker-tutorial) ([local](./../_unsorted/running-a-nats-service/nats-docker/nats-docker-tutorial.md)) for more instructions on using the NATS server Docker image.

[PreviousEnvironmental considerationschevron-left](https://docs.nats.io/running-a-nats-service/environment) ([local](./03_environmental-considerations.md))[NextTutorialchevron-right](https://docs.nats.io/running-a-nats-service/nats_docker/nats-docker-tutorial) ([local](./../_unsorted/running-a-nats-service/nats-docker/nats-docker-tutorial.md))
