---
title: What's New!
source: https://docs.nats.io/release-notes/whats_new
---

[githubEdit](https://github.com/nats-io/nats.docs/blob/master/release_notes/whats_new.md)chevron-down

block-quoteOn this pageblock-quote

  1. [Release Notes](https://docs.nats.io/release-notes) ([local](./../_unsorted/release-notes.md))

# What's New!

The NATS.io team is continually working to bring you features that enhance your NATS experience. Below, you will find summaries of new NATS implementations. Release notes for the latest patch releases are available on [GitHub Releasesarrow-up-right](https://github.com/nats-io/nats-server/releases)

## 

[hashtag](#roadmap-for-future-releases)

Roadmap for future releases

See <https://nats.io/about/#roadmap>[arrow-up-right](https://nats.io/about/#roadmap)

## 

[hashtag](#server-release-v2.14.0)

Server release v2.14.0

Check out the:

  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_214) ([local](./../_unsorted/release-notes/whats-new/whats-new-214.md))

  * [Release notesarrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.14.0)

## 

[hashtag](#server-release-v2.12.0)

Server release v2.12.0

Check out the:

  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_212) ([local](./../_unsorted/release-notes/whats-new/whats-new-212.md))

  * [Release notesarrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.12.0)

## 

[hashtag](#server-release-v2.11.0)

Server release v2.11.0

Check out the:

  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_211) ([local](./../_unsorted/release-notes/whats-new/whats-new-211.md))

  * [Release notesarrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.11.0)

## 

[hashtag](#server-release-v2.10.0)

Server release v2.10.0

Check out the:

  * [Upgrade guide](https://docs.nats.io/release-notes/whats_new/whats_new_210) ([local](./../_unsorted/release-notes/whats-new/whats-new-210.md))

  * [Podcast EP06: The journey and features of the NATS.io 2.10 releasearrow-up-right](https://youtu.be/9J4pRzHSc2k)

  * [Release notesarrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.10.0)

## 

[hashtag](#server-release-v2.9.0)

Server release v2.9.0

Please check out the [announcement postarrow-up-right](https://nats.io/blog/nats-server-29-release/) on the blog and the [detailed release notesarrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.9.0) in the server repo.

## 

[hashtag](#server-release-v2.8.0)
...
For full release information, see links below;
  ...
  * Release notes [2.8.0arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.8.0)

  * Full list of Changes [2.7.4...2.8.0arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.7.4...v2.8.0)

## 

[hashtag](#server-release-v2.7.0)

Server release v2.7.0

### 

[hashtag](#notice-for-jetstream-users)

**Notice for JetStream Users**

See [important notearrow-up-right](https://github.com/nats-io/nats-server/pull/2693#issuecomment-996212582) if using LeafNode regarding domains.
...
For full release information, see links below;
  ...
  * Release notes [2.7.0arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.7.0)

  * Full list of Changes [2.6.6...2.7.0arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.6.6...v2.7.0)

## 

[hashtag](#server-release-v2.6.0)

Server release v2.6.0

### 

[hashtag](#notice-for-jetstream-users-1)

**Notice for JetStream Users**

See important [notearrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.4.0) if upgrading from a version prior to NATS Server v2.4.0.

### 

[hashtag](#notice-for-mqtt-users)

Notice for MQTT Users

See important [notesarrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.5.0) if upgrading from a version prior to v2.5.0.
...
For full release information, see links below;
  ...
  * Release notes [2.6.0arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.6.0)

  * Full list of Changes [2.5.0...2.6.0arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.6.0...v2.5.0)

## 

[hashtag](#server-release-v2.5.0)

Server release v2.5.0

### 

[hashtag](#notice-for-jetstream-users-2)

**Notice for JetStream Users**

See important [notearrow-up-right](https://github.com/nats-io/nats.docs/blob/master/release_notes/README.md#notice-for-jetstream-users) if upgrading from a version prior to NATS Server v2.4.0.

### 

[hashtag](#mqtt-monitoring)
...
For full release information, see links below;
  ...
  * Release notes [2.5.0arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.5.0)

  * Full list of Changes [2.4.0...2.5.0arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.4.0...v2.5.0)

## 

[hashtag](#server-release-v2.4.0)

Server release v2.4.0

### 

[hashtag](#notice-for-jetstream-users-3)
...
For full release information, see links below;
  ...
  * Release notes [2.4.0arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.4.0)

  * Full list of Changes [2.3.4...2.4.0arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.3.4...v2.4.0)

## 

[hashtag](#server-release-v2.3.0)

Server release v2.3.0

  * [OCSP support](https://docs.nats.io/running-a-nats-service/configuration/securing_nats/ocsp) ([local](./../_unsorted/running-a-nats-service/configuration/securing-nats/ocsp.md))
...
For full release information, see links below;
  ...
  * Release notes [2.3.0arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.3.0)

  * Full list of Changes [2.2.6...2.3.0arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.2.6...v2.3.0)

## 

[hashtag](#server-release-v2.2.0)

Server release v2.2.0

See [NATS 2.2](https://docs.nats.io/release-notes/whats_new/whats_new_22) ([local](./../_unsorted/release-notes/whats-new/whats-new-22.md)) for new features.

## 

[hashtag](#server-release-v2.1.7)

Server release v2.1.7

### 

[hashtag](#monitoring-endpoints-available-via-system-services)
...
For more information on monitoring endpoints see [NATS Server Configurations System Events](https://docs.nats.io/running-a-nats-service/configuration/sys_accounts) ([local](./../_unsorted/running-a-nats-service/configuration/sys-accounts.md)).

### 

[hashtag](#addition-of-no_auth_user-configuration)
...
For more information and examples, see [Securing NATS](https://docs.nats.io/running-a-nats-service/configuration/securing_nats) ([local](./../_unsorted/running-a-nats-service/configuration/securing-nats.md))

For full release information, see links below;

  * Release notes [2.1.7arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.1.7)

  * Full list of Changes [2.1.6...2.1.7arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.1.6...v2.1.7)

## 

[hashtag](#server-release-v2.1.6)

Server release v2.1.6

### 

[hashtag](#tls-configuration-for-account-resolver)
...
[hashtag](#additional-trace-and-debug-verbosity-options)

Additional Trace & Debug Verbosity Options

`trace_verbose` and command line parameters `-VV` and `-DVV` added. See [NATS Logging Configuration](https://docs.nats.io/running-a-nats-service/configuration/logging#configuring-logging) ([local](./../_unsorted/running-a-nats-service/configuration/logging.md#configuring-logging))

### 

[hashtag](#subscription-details-in-monitoring-endpoints)
...
We've added the option to include subscription details in monitoring endpoints `/routez` and `/connz`. For instance `/connz?subs=detail` will now return not only the subjects of the subscription, but the queue name (if applicable) and some other details.
  ...
  * Release notes [2.1.6arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.1.6)

  * Full list of Changes [2.1.4...2.1.6arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.1.4...v2.1.6)

## 

[hashtag](#server-release-v2.1.4)
...
Queue Permissions allow you to express authorization for queue groups. As queue groups are integral to implementing horizontally scalable microservices, control of who is allowed to join a specific queue group is important to the overall security model. Original PR - <https://github.com/nats-io/nats-server/pull/1143>[arrow-up-right](https://github.com/nats-io/nats-server/pull/1143)

More information on Queue Permissions can be found in the [Developing with NATS](https://docs.nats.io/using-nats/developer/receiving/queues) ([local](./../_unsorted/using-nats/developer/receiving/queues.md)) section.

## 

[hashtag](#server-release-v2.1.0)

Server release v2.1.0

### 

[hashtag](#service-latency-tracking)
...
As services and service mesh functionality has become prominent, we have been looking at ways to make running scalable services on NATS.io a great experience. One area we have been looking at is observability. With publish/subscribe systems, everything is inherently observable, however we realized it was not as simple as it could be. We wanted the ability to transparently add service latency tracking to any given service with no changes to the application. We also realized that global systems, such as those NATS.io can support, needed something more than a single metric. The solution was to allow any sampling rate to be attached to an exported service, with a delivery subject for all collected metrics. We collect metrics that show the requestor’s view of latency, the responder’s view of latency and the NATS subsystem itself, even when requestor and responder are in different parts of the world and connected to different servers in a NATS supercluster.
  ...
  * Release notes [2.1.0arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.1.0)

  * Full list of Changes [2.0.4...2.1.0arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.0.4...v2.1.0)

## 

[hashtag](#server-release-v2.0.4)

Server release v2.0.4

### 

[hashtag](#response-only-permissions)
...
Exported Services were originally tied to a single response. We added the type for the service response and now support singletons (default), streams and chunked. Stream responses represent multiple response messages, chunked represents a single response that may have to be broken up into multiple messages.
  ...
  * Release notes [2.0.4arrow-up-right](https://github.com/nats-io/nats-server/releases/tag/v2.0.4)

  * Full list of Changes [2.0.2...2.0.4arrow-up-right](https://github.com/nats-io/nats-server/compare/v2.0.2...v2.0.4)

[PreviousWelcomechevron-left](https://docs.nats.io/) ([local](./../index.md))[NextNATS 2.14chevron-right](https://docs.nats.io/release-notes/whats_new/whats_new_214) ([local](./../_unsorted/release-notes/whats-new/whats-new-214.md))
