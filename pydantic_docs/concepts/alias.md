...
[`to_pascal`](<https://pydantic.dev/docs/validation/latest/api/pydantic/config/#pydantic.alias_generators.to_pascal>)  
[`to_camel`](<https://pydantic.dev/docs/validation/latest/api/pydantic/config/#pydantic.alias_generators.to_camel>)  
[`to_snake`](<https://pydantic.dev/docs/validation/latest/api/pydantic/config/#pydantic.alias_generators.to_snake>)  
...
When validating data, you can enable population of attributes by attribute name, alias, or both. **By default** , Pydantic uses aliases for validation. Further configuration is available via:
  ...
  * [ validate_by_alias ](<https://pydantic.dev/docs/validation/latest/concepts/alias#tab-panel-516>)
  * [ validate_by_name ](<https://pydantic.dev/docs/validation/latest/concepts/alias#tab-panel-517>)
  * [ validate_by_alias and validate_by_name ](<https://pydantic.dev/docs/validation/latest/concepts/alias#tab-panel-518>)
...
You cannot set both `validate_by_alias` and `validate_by_name` to `False`. A [user error](<https://pydantic.dev/docs/validation/latest/errors/usage_errors#validate-by-alias-and-name-false>) is raised in this case.
...
By default:
  ...
  * [ by_alias ](<https://pydantic.dev/docs/validation/latest/concepts/alias#tab-panel-519>)
  * [ by_name ](<https://pydantic.dev/docs/validation/latest/concepts/alias#tab-panel-520>)
  * [ validate_by_alias and validate_by_name ](<https://pydantic.dev/docs/validation/latest/concepts/alias#tab-panel-521>)
...
You cannot set both `by_alias` and `by_name` to `False`. A [user error](<https://pydantic.dev/docs/validation/latest/errors/usage_errors#validate-by-alias-and-name-false>) is raised in this case.
...
[ Previous   
Unions ](<https://pydantic.dev/docs/validation/latest/concepts/unions/>) [ Next   
