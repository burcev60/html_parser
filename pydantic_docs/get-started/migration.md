...
<https://pydantic.dev/docs/validation/latest/get-started/migration#install-pydantic-v2> ([local](./migration.md#install-pydantic-v2)) ([local](./migration.md#install-pydantic-v2))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#code-transformation-tool> ([local](./migration.md#code-transformation-tool)) ([local](./migration.md#code-transformation-tool))
...
cd /path/to/repo_folder bump-pydantic my_package
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#continue-using-pydantic-v1-features> ([local](./migration.md#continue-using-pydantic-v1-features)) ([local](./migration.md#continue-using-pydantic-v1-features))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#using-pydantic-v1-features-in-a-v1v2-environment> ([local](./migration.md#using-pydantic-v1-features-in-a-v1v2-environment)) ([local](./migration.md#using-pydantic-v1-features-in-a-v1v2-environment))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#migration-guide> ([local](./migration.md#migration-guide)) ([local](./migration.md#migration-guide))

The following sections provide details on the most important changes in Pydantic V2.

### Changes to `pydantic.BaseModel`

<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-pydanticbasemodel> ([local](./migration.md#changes-to-pydanticbasemodel)) ([local](./migration.md#changes-to-pydanticbasemodel))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-pydanticgenericsgenericmodel> ([local](./migration.md#changes-to-pydanticgenericsgenericmodel)) ([local](./migration.md#changes-to-pydanticgenericsgenericmodel))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-pydanticfield> ([local](./migration.md#changes-to-pydanticfield)) ([local](./migration.md#changes-to-pydanticfield))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-dataclasses> ([local](./migration.md#changes-to-dataclasses)) ([local](./migration.md#changes-to-dataclasses))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-config> ([local](./migration.md#changes-to-config)) ([local](./migration.md#changes-to-config))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-validators> ([local](./migration.md#changes-to-validators)) ([local](./migration.md#changes-to-validators))

#### `@validator` and `@root_validator` are deprecated

<https://pydantic.dev/docs/validation/latest/get-started/migration#validator-and-root_validator-are-deprecated> ([local](./migration.md#validator-and-root_validator-are-deprecated)) ([local](./migration.md#validator-and-root_validator-are-deprecated))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-validators-allowed-signatures> ([local](./migration.md#changes-to-validators-allowed-signatures)) ([local](./migration.md#changes-to-validators-allowed-signatures))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#typeerror-is-no-longer-converted-to-validationerror-in-validators> ([local](./migration.md#typeerror-is-no-longer-converted-to-validationerror-in-validators)) ([local](./migration.md#typeerror-is-no-longer-converted-to-validationerror-in-validators))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#validator-behavior-changes> ([local](./migration.md#validator-behavior-changes)) ([local](./migration.md#validator-behavior-changes))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#the-allow_reuse-keyword-argument-is-no-longer-necessary> ([local](./migration.md#the-allow_reuse-keyword-argument-is-no-longer-necessary)) ([local](./migration.md#the-allow_reuse-keyword-argument-is-no-longer-necessary))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#validate_arguments-has-been-renamed-to-validate_call> ([local](./migration.md#validate_arguments-has-been-renamed-to-validate_call)) ([local](./migration.md#validate_arguments-has-been-renamed-to-validate_call))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#input-types-are-not-preserved> ([local](./migration.md#input-types-are-not-preserved)) ([local](./migration.md#input-types-are-not-preserved))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-handling-of-standard-types> ([local](./migration.md#changes-to-handling-of-standard-types)) ([local](./migration.md#changes-to-handling-of-standard-types))

#### Dicts

<https://pydantic.dev/docs/validation/latest/get-started/migration#dicts> ([local](./migration.md#dicts)) ([local](./migration.md#dicts))

Iterables of pairs (which include empty iterables) no longer pass validation for fields of type `dict`.

#### Unions

<https://pydantic.dev/docs/validation/latest/get-started/migration#unions> ([local](./migration.md#unions)) ([local](./migration.md#unions))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#required-optional-and-nullable-fields> ([local](./migration.md#required-optional-and-nullable-fields)) ([local](./migration.md#required-optional-and-nullable-fields))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#patterns--regex-on-strings> ([local](./migration.md#patterns--regex-on-strings)) ([local](./migration.md#patterns--regex-on-strings))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#type-conversion-from-floats-to-integers> ([local](./migration.md#type-conversion-from-floats-to-integers)) ([local](./migration.md#type-conversion-from-floats-to-integers))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#introduction-of-typeadapter> ([local](./migration.md#introduction-of-typeadapter)) ([local](./migration.md#introduction-of-typeadapter))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#defining-custom-types> ([local](./migration.md#defining-custom-types)) ([local](./migration.md#defining-custom-types))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#changes-to-json-schema-generation> ([local](./migration.md#changes-to-json-schema-generation)) ([local](./migration.md#changes-to-json-schema-generation))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#basesettings-has-moved-to-pydantic-settings> ([local](./migration.md#basesettings-has-moved-to-pydantic-settings)) ([local](./migration.md#basesettings-has-moved-to-pydantic-settings))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#color-and-payment-card-numbers-moved-to-pydantic-extra-types> ([local](./migration.md#color-and-payment-card-numbers-moved-to-pydantic-extra-types)) ([local](./migration.md#color-and-payment-card-numbers-moved-to-pydantic-extra-types))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#url-and-dsn-types-in-pydanticnetworks-no-longer-inherit-from-str> ([local](./migration.md#url-and-dsn-types-in-pydanticnetworks-no-longer-inherit-from-str)) ([local](./migration.md#url-and-dsn-types-in-pydanticnetworks-no-longer-inherit-from-str))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#constrained-types> ([local](./migration.md#constrained-types)) ([local](./migration.md#constrained-types))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#mypy-plugins> ([local](./migration.md#mypy-plugins)) ([local](./migration.md#mypy-plugins))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#other-changes> ([local](./migration.md#other-changes)) ([local](./migration.md#other-changes))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#moved-in-pydantic-v2> ([local](./migration.md#moved-in-pydantic-v2)) ([local](./migration.md#moved-in-pydantic-v2))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#deprecated-and-moved-in-pydantic-v2> ([local](./migration.md#deprecated-and-moved-in-pydantic-v2)) ([local](./migration.md#deprecated-and-moved-in-pydantic-v2))
...
<https://pydantic.dev/docs/validation/latest/get-started/migration#removed-in-pydantic-v2> ([local](./migration.md#removed-in-pydantic-v2)) ([local](./migration.md#removed-in-pydantic-v2))
