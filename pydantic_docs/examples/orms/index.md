---
title: Databases
source: https://pydantic.dev/docs/validation/latest/examples/orms/
---
...
[](<https://pydantic.dev/docs/validation/latest/examples/orms/#sqlalchemy>)
...
[ Previous   
Queues ](<https://pydantic.dev/docs/validation/latest/examples/queues/>) [ Next   
Custom Validators ](<https://pydantic.dev/docs/validation/latest/examples/custom_validators/>)
