...
source: https://pydantic.dev/docs/validation/latest/examples/custom_validators/
---
...
[](<https://pydantic.dev/docs/validation/latest/examples/custom_validators/#custom-datetime-validator-via-annotated-metadata>)
...
The `handler` function is what we call to validate the input with standard `pydantic` validation

We call the `handler` function to validate the input with standard `pydantic` validation in this wrap validator
...
[](<https://pydantic.dev/docs/validation/latest/examples/custom_validators/#validating-nested-model-fields>)
...
More details about validation context can be found in the [validators documentation](<https://pydantic.dev/docs/validation/latest/concepts/validators#validation-context>).
...
[ Previous   
Databases ](<https://pydantic.dev/docs/validation/latest/examples/orms/>) [ Next   
Dynamic models ](<https://pydantic.dev/docs/validation/latest/examples/dynamic_models/>)
