---
title: AWS Lambda
source: https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/
---
...
<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#installing-python-libraries-for-aws-lambda-functions> ([local](./aws_lambda.md#installing-python-libraries-for-aws-lambda-functions)) ([local](./aws_lambda.md#installing-python-libraries-for-aws-lambda-functions))
...
<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#installing-pydantic-for-aws-lambda-functions> ([local](./aws_lambda.md#installing-pydantic-for-aws-lambda-functions)) ([local](./aws_lambda.md#installing-pydantic-for-aws-lambda-functions))
...
```
    ...
    pip install   --platform manylinux2014_x86_64   # (1)
...
<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#troubleshooting> ([local](./aws_lambda.md#troubleshooting)) ([local](./aws_lambda.md#troubleshooting))

### Missing `pydantic_core` module

<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#missing-pydantic_core-module> ([local](./aws_lambda.md#missing-pydantic_core-module)) ([local](./aws_lambda.md#missing-pydantic_core-module))
...
<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#no-package-metadata-was-found-for-email-validator> ([local](./aws_lambda.md#no-package-metadata-was-found-for-email-validator)) ([local](./aws_lambda.md#no-package-metadata-was-found-for-email-validator))
...
<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#extra-resources> ([local](./aws_lambda.md#extra-resources)) ([local](./aws_lambda.md#extra-resources))

### More Debugging Tips

<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#more-debugging-tips> ([local](./aws_lambda.md#more-debugging-tips)) ([local](./aws_lambda.md#more-debugging-tips))
...
<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#validating-event-and-context-data> ([local](./aws_lambda.md#validating-event-and-context-data)) ([local](./aws_lambda.md#validating-event-and-context-data))
