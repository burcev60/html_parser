---
title: Pyrefly
source: https://pydantic.dev/docs/validation/latest/integrations/dev-tools/pyrefly/
---
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/pyrefly/#ide-extension>)
...
![Signature help with the Pyrefly IDE extension](https://pydantic.dev/docs/validation/latest/img/pyrefly.png)

As you type `Model()`, Pyrefly hints that you need to use the name `x_` to populate the `x` field.

## Type checker

[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/pyrefly/#type-checker>)
...
[ Previous   
Mypy ](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/mypy/>) [ Next   
PyCharm ](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/pycharm/>)
