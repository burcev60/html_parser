...
source: https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/
---
...
![pydantic autocompletion in VS Code](https://pydantic.dev/docs/validation/latest/img/vs_code_01.png)

## Configure VS Code

[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#configure-vs-code>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#install-pylance>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#configure-your-environment>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#configure-pylance>)
...
![Type Checking Mode set to strict in VS Code](https://pydantic.dev/docs/validation/latest/img/vs_code_02.png)
...
![Required arguments error checks in VS Code](https://pydantic.dev/docs/validation/latest/img/vs_code_03.png)

And you will also get error checks for **invalid data types**.

![Invalid data types error checks in VS Code](https://pydantic.dev/docs/validation/latest/img/vs_code_04.png)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#configure-mypy>)
...
![mypy enabled in VS Code](https://pydantic.dev/docs/validation/latest/img/vs_code_05.png)

## Tips and tricks

[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#tips-and-tricks>)

Here are some additional tips and tricks to improve your developer experience when using VS Code with Pydantic.

### Strict errors

[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#strict-errors>)
...
![VS Code strict type errors](https://pydantic.dev/docs/validation/latest/img/vs_code_06.png)
...
![VS Code strict type errors with model](https://pydantic.dev/docs/validation/latest/img/vs_code_07.png)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#disable-type-checks-in-a-line>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#override-the-type-of-a-variable>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#override-the-type-of-a-value-with-cast>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#config-in-class-arguments>)
...
![VS Code strict type errors with model](https://pydantic.dev/docs/validation/latest/img/vs_code_08.png)

## Adding a default with `Field`

[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#adding-a-default-with-field>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/visual_studio_code/#technical-details>)
...
[ Previous   
Hypothesis ](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/hypothesis/>) [ Next   
datamodel-code-generator ](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/datamodel_code_generator/>)
