...
[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#installing-python-libraries-for-aws-lambda-functions>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#installing-pydantic-for-aws-lambda-functions>)
...
Use the platform corresponding to your Lambda runtime.

Specify the directory where you want to install the package (often `python` for Lambda Layers).

Use the CPython implementation.

The Python version must be compatible with the Lambda runtime.

This flag ensures that the package is installed pre-built binary wheels.

The latest version of `pydantic` will be installed.

## Troubleshooting

[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#troubleshooting>)

### Missing `pydantic_core` module

[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#missing-pydantic_core-module>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#no-package-metadata-was-found-for-email-validator>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#extra-resources>)

### More Debugging Tips

[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#more-debugging-tips>)
...
[](<https://pydantic.dev/docs/validation/latest/integrations/aws_lambda/#validating-event-and-context-data>)
...
[ Previous   
Documentation ](<https://pydantic.dev/docs/validation/latest/integrations/dev-tools/documentation/>) [ Next   
