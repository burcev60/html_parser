...
[ Previous   
pydantic_core ](<https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core/>) [ Next   
Pydantic Settings ](<https://pydantic.dev/docs/validation/latest/api/pydantic_settings/>)
