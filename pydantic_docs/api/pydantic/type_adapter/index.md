...
[JSON Serialization](<https://pydantic.dev/docs/validation/latest/concepts/json#json-serialization>)
...
[ Previous   
Pydantic Dataclasses ](<https://pydantic.dev/docs/validation/latest/api/pydantic/dataclasses/>) [ Next   
Validate Call ](<https://pydantic.dev/docs/validation/latest/api/pydantic/validate_call/>)
