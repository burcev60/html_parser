...
[`RootModel` and Custom Root Types](<https://pydantic.dev/docs/validation/latest/concepts/models#rootmodel-and-custom-root-types>)
...
[ Previous   
BaseModel ](<https://pydantic.dev/docs/validation/latest/api/pydantic/base_model/>) [ Next   
