...
[ Previous   
JSON Schema ](<https://pydantic.dev/docs/validation/latest/api/pydantic/json_schema/>) [ Next   
Functional Validators ](<https://pydantic.dev/docs/validation/latest/api/pydantic/functional_validators/>)
