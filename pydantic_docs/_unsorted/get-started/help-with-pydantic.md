...
The [API documentation](https://pydantic.dev/docs/validation/latest/api/pydantic/base_model) ([local](./../api/pydantic/base-model.md)) gives reference docs for all public Pydantic APIs.
