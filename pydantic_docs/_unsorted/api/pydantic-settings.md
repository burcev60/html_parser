...
#pydantic_settings.SecretsSettingsSource
...
#pydantic_settings.SecretsSettingsSource.find_case_path
...
#pydantic_settings.SecretsSettingsSource.find_case_path\(dir_path\)

Directory path.

**`file_name`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_settings.SecretsSettingsSource.find_case_path\(file_name\)

File name.

**`case_sensitive`** : [`bool`](https://docs.python.org/3/library/functions.html#bool)

#pydantic_settings.SecretsSettingsSource.find_case_path\(case_sensitive\)

Whether to search for file name case sensitively.

#### get_field_value 

#pydantic_settings.SecretsSettingsSource.get_field_value
...
#pydantic_settings.SecretsSettingsSource.get_field_value\(field\)

The field.

**`field_name`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_settings.SecretsSettingsSource.get_field_value\(field_name\)

The field name.

## ForceDecode 

#pydantic_settings.ForceDecode

Annotation to force decoding of a field value.

## DotEnvSettingsSource 

#pydantic_settings.DotEnvSettingsSource
...
#pydantic_settings.EnvSettingsSource
...
#pydantic_settings.EnvSettingsSource.get_field_value
...
#pydantic_settings.EnvSettingsSource.get_field_value\(field\)

The field.

**`field_name`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_settings.EnvSettingsSource.get_field_value\(field_name\)

The field name.

#### prepare_field_value 

#pydantic_settings.EnvSettingsSource.prepare_field_value
...
#pydantic_settings.EnvSettingsSource.prepare_field_value\(field\)

The field.

**`field_name`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_settings.EnvSettingsSource.prepare_field_value\(field_name\)
...
#pydantic_settings.EnvSettingsSource.next_field
...
#pydantic_settings.EnvSettingsSource.next_field\(field\)

The field.

**`key`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_settings.EnvSettingsSource.next_field\(key\)
...
#pydantic_settings.EnvSettingsSource.next_field\(case_sensitive\)

Whether to search for key case sensitively.

#### explode_env_vars 

#pydantic_settings.EnvSettingsSource.explode_env_vars
...
#pydantic_settings.EnvSettingsSource.explode_env_vars\(field_name\)

The field name.

**`field`** : `FieldInfo`

#pydantic_settings.EnvSettingsSource.explode_env_vars\(field\)
...
#pydantic_settings.EnvSettingsSource.explode_env_vars\(env_vars\)
...
#pydantic_settings.SettingsConfigDict.yaml_config_section
...
#pydantic_settings.SettingsConfigDict.pyproject_toml_depth
...
#pydantic_settings.SettingsConfigDict.pyproject_toml_table_header
...
#pydantic_settings.PydanticBaseSettingsSource.current_state
...
#pydantic_settings.PydanticBaseSettingsSource.settings_sources_data
...
#pydantic_settings.PydanticBaseSettingsSource.get_field_value
...
#pydantic_settings.PydanticBaseSettingsSource.get_field_value\(field\)

The field.

**`field_name`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_settings.PydanticBaseSettingsSource.get_field_value\(field_name\)

The field name.

#### field_is_complex 

#pydantic_settings.PydanticBaseSettingsSource.field_is_complex
...
#pydantic_settings.PydanticBaseSettingsSource.field_is_complex\(field\)

The field.

#### prepare_field_value 

#pydantic_settings.PydanticBaseSettingsSource.prepare_field_value
...
#pydantic_settings.PydanticBaseSettingsSource.prepare_field_value\(field_name\)

The field name.

**`field`** : `FieldInfo`

#pydantic_settings.PydanticBaseSettingsSource.prepare_field_value\(field\)

The field.

**`value`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)

#pydantic_settings.PydanticBaseSettingsSource.prepare_field_value\(value\)

The value of the field that has to be prepared.

**`value_is_complex`** : [`bool`](https://docs.python.org/3/library/functions.html#bool)

#pydantic_settings.PydanticBaseSettingsSource.prepare_field_value\(value_is_complex\)

A flag to determine whether value is complex.

#### decode_complex_value 

#pydantic_settings.PydanticBaseSettingsSource.decode_complex_value
...
#pydantic_settings.PydanticBaseSettingsSource.decode_complex_value\(field_name\)

The field name.

**`field`** : `FieldInfo`

#pydantic_settings.PydanticBaseSettingsSource.decode_complex_value\(field\)

The field.

**`value`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)

#pydantic_settings.PydanticBaseSettingsSource.decode_complex_value\(value\)
...
**Bases:** [`BaseModel`](https://pydantic.dev/docs/validation/latest/api/pydantic/base_model/#pydantic.BaseModel) ([local](./pydantic/base-model.md#pydantic.BaseModel))
...
#pydantic_settings.BaseSettings.__init__\(_case_sensitive\)
...
#pydantic_settings.BaseSettings.__init__\(_nested_model_default_partial_update\)
...
#pydantic_settings.BaseSettings.__init__\(_env_prefix\)
...
#pydantic_settings.BaseSettings.__init__\(_env_prefix_target\)
...
#pydantic_settings.BaseSettings.__init__\(_env_file\)
...
#pydantic_settings.BaseSettings.__init__\(_env_file_encoding\)
...
#pydantic_settings.BaseSettings.__init__\(_env_ignore_empty\)
...
#pydantic_settings.BaseSettings.__init__\(_env_nested_delimiter\)
...
#pydantic_settings.BaseSettings.__init__\(_env_nested_max_split\)
...
#pydantic_settings.BaseSettings.__init__\(_env_parse_none_str\)
...
#pydantic_settings.BaseSettings.__init__\(_env_parse_enums\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_prog_name\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_parse_args\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_settings_source\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_parse_none_str\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_hide_none_type\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_avoid_json\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_enforce_required\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_use_class_docs_for_groups\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_exit_on_error\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_prefix\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_flag_prefix_char\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_implicit_flags\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_ignore_unknown_args\)
...
#pydantic_settings.BaseSettings.__init__\(_cli_kebab_case\)

CLI args use kebab case. Defaults to `False`.

**`_cli_shortcuts`** : [`Mapping`](https://docs.python.org/3/library/typing.html#typing.Mapping)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`list`](https://docs.python.org/3/glossary.html#term-list)[[`str`](https://docs.python.org/3/library/stdtypes.html#str)]] | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic_settings.BaseSettings.__init__\(_cli_shortcuts\)
...
#pydantic_settings.BaseSettings.__init__\(_secrets_dir\)
...
#pydantic_settings.BaseSettings.__init__\(_build_sources\)
...
#pydantic_settings.BaseSettings.settings_customise_sources
...
#pydantic_settings.BaseSettings.settings_customise_sources\(settings_cls\)

The Settings class.

**`init_settings`** : `PydanticBaseSettingsSource`

#pydantic_settings.BaseSettings.settings_customise_sources\(init_settings\)

The `InitSettingsSource` instance.

**`env_settings`** : `PydanticBaseSettingsSource`

#pydantic_settings.BaseSettings.settings_customise_sources\(env_settings\)

The `EnvSettingsSource` instance.

**`dotenv_settings`** : `PydanticBaseSettingsSource`

#pydantic_settings.BaseSettings.settings_customise_sources\(dotenv_settings\)

The `DotEnvSettingsSource` instance.

**`file_secret_settings`** : `PydanticBaseSettingsSource`

#pydantic_settings.BaseSettings.settings_customise_sources\(file_secret_settings\)

The `SecretsSettingsSource` instance.

## GoogleSecretManagerSettingsSource 

#pydantic_settings.GoogleSecretManagerSettingsSource
...
#pydantic_settings.GoogleSecretManagerSettingsSource.get_field_value
...
#pydantic_settings.GoogleSecretManagerSettingsSource.get_field_value\(field\)

The field to get the value for

**`field_name`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_settings.GoogleSecretManagerSettingsSource.get_field_value\(field_name\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_prog_name\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_parse_args\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_parse_none_str\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_hide_none_type\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_avoid_json\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_enforce_required\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_use_class_docs_for_groups\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_exit_on_error\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_prefix\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_flag_prefix_char\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_implicit_flags\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_ignore_unknown_args\)
...
#pydantic_settings.CliSettingsSource.__init__\(cli_kebab_case\)

CLI args use kebab case. Defaults to `False`.

**`cli_shortcuts`** : [`Mapping`](https://docs.python.org/3/library/typing.html#typing.Mapping)[[`str`](https://docs.python.org/3/library/stdtypes.html#str), [`str`](https://docs.python.org/3/library/stdtypes.html#str) | [`list`](https://docs.python.org/3/glossary.html#term-list)[[`str`](https://docs.python.org/3/library/stdtypes.html#str)]] | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic_settings.CliSettingsSource.__init__\(cli_shortcuts\)
...
#pydantic_settings.CliSettingsSource.__init__\(case_sensitive\)
...
#pydantic_settings.CliSettingsSource.__init__\(root_parser\)
...
#pydantic_settings.CliSettingsSource.__init__\(parse_args_method\)
...
#pydantic_settings.CliSettingsSource.__init__\(add_argument_method\)
...
#pydantic_settings.CliSettingsSource.__init__\(add_argument_group_method\)
...
#pydantic_settings.CliSettingsSource.__init__\(add_parser_method\)
...
#pydantic_settings.CliSettingsSource.__init__\(add_subparsers_method\)
...
#pydantic_settings.CliSettingsSource.__init__\(format_help_method\)
...
#pydantic_settings.CliSettingsSource.__init__\(formatter_class\)
...
#pydantic_settings.CliSettingsSource.root_parser
...
#pydantic_settings.CliApp.run\(cli_settings_source\)

Override the default CLI settings source with a user defined instance. Defaults to `None`.

**`cli_exit_on_error`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic_settings.CliApp.run\(cli_exit_on_error\)
...
#pydantic_settings.CliApp.run\(cli_cmd_method_name\)
...
#pydantic_settings.CliApp.run\(model_init_data\)
...
#pydantic_settings.CliApp.run_subcommand
...
#pydantic_settings.CliApp.run_subcommand\(cli_exit_on_error\)
...
#pydantic_settings.CliApp.run_subcommand\(cli_cmd_method_name\)
...
#pydantic_settings.CliApp.serialize
...
#pydantic_settings.CliApp.serialize\(model\)
...
#pydantic_settings.CliApp.serialize\(list_style\)
...
#pydantic_settings.CliApp.serialize\(dict_style\)
...
#pydantic_settings.CliApp.format_help\(model\)

The model or model class.

**`cli_settings_source`** : `CliSettingsSource`[[`Any`](https://docs.python.org/3/library/typing.html#typing.Any)] | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic_settings.CliApp.format_help\(cli_settings_source\)

Override the default CLI settings source with a user defined instance. Defaults to `None`.

**`strip_ansi_color`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic_settings.CliApp.format_help\(strip_ansi_color\)

Strips ANSI color codes from the help message when set to `True`.

#### print_help 

#pydantic_settings.CliApp.print_help
...
#pydantic_settings.CliApp.print_help\(model\)

The model or model class.

**`cli_settings_source`** : `CliSettingsSource`[[`Any`](https://docs.python.org/3/library/typing.html#typing.Any)] | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic_settings.CliApp.print_help\(cli_settings_source\)
...
#pydantic_settings.CliApp.print_help\(file\)

A text stream to which the help message is written. If `None`, the output is sent to sys.stdout.

**`strip_ansi_color`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic_settings.CliApp.print_help\(strip_ansi_color\)
