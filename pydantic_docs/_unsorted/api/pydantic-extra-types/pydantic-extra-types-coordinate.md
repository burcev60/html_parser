...
The `pydantic_extra_types.coordinate` module provides the [`Latitude`](#pydantic_extra_types.coordinate.Latitude), [`Longitude`](#pydantic_extra_types.coordinate.Longitude), and [`Coordinate`](#pydantic_extra_types.coordinate.Coordinate) data types.

## Latitude 

#pydantic_extra_types.coordinate.Latitude
...
#pydantic_extra_types.coordinate.Longitude
