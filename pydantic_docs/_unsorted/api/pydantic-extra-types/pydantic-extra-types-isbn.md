...
#pydantic_extra_types.isbn.ISBN
...
#pydantic_extra_types.isbn.ISBN.validate_isbn_format
...
#pydantic_extra_types.isbn.ISBN.validate_isbn_format\(value\)
...
#pydantic_extra_types.isbn.ISBN.convert_isbn10_to_isbn13
...
#pydantic_extra_types.isbn.ISBN.convert_isbn10_to_isbn13\(value\)

The ISBN-10 value to be converted.

## isbn10_digit_calc 

#pydantic_extra_types.isbn.isbn10_digit_calc
...
#pydantic_extra_types.isbn.isbn10_digit_calc\(isbn\)

The str value representing the ISBN in 10 digits.

## isbn13_digit_calc 

#pydantic_extra_types.isbn.isbn13_digit_calc
...
#pydantic_extra_types.isbn.isbn13_digit_calc\(isbn\)
