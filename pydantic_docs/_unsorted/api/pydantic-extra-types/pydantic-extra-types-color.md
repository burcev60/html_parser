...
#pydantic_extra_types.color.RGBA
...
#pydantic_extra_types.color.Color.original
...
#pydantic_extra_types.color.Color.as_named
...
#pydantic_extra_types.color.Color.as_named\(fallback\)
...
#pydantic_extra_types.color.Color.as_hex
...
#pydantic_extra_types.color.Color.as_rgb
...
#pydantic_extra_types.color.Color.as_rgb_tuple
...
#pydantic_extra_types.color.Color.as_rgb_tuple\(alpha\)
...
#pydantic_extra_types.color.Color.as_hsl
...
#pydantic_extra_types.color.Color.as_hsl_tuple
...
#pydantic_extra_types.color.Color.as_hsl_tuple\(alpha\)
...
#pydantic_extra_types.color.parse_tuple
...
#pydantic_extra_types.color.parse_tuple\(value\)
...
#pydantic_extra_types.color.parse_str
...
#pydantic_extra_types.color.parse_str\(value\)
...
#pydantic_extra_types.color.ints_to_rgba
...
#pydantic_extra_types.color.ints_to_rgba\(r\)
...
#pydantic_extra_types.color.ints_to_rgba\(g\)
...
#pydantic_extra_types.color.ints_to_rgba\(b\)
...
#pydantic_extra_types.color.ints_to_rgba\(alpha\)

A float representing the alpha value. Defaults to None.

## parse_color_value 

#pydantic_extra_types.color.parse_color_value
...
#pydantic_extra_types.color.parse_float_alpha
...
#pydantic_extra_types.color.parse_float_alpha\(value\)
...
#pydantic_extra_types.color.parse_hsl
...
#pydantic_extra_types.color.parse_hsl\(h\)

The hue value.

**`h_units`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_extra_types.color.parse_hsl\(h_units\)

The unit for hue value.

**`sat`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_extra_types.color.parse_hsl\(sat\)

The saturation value.

**`light`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str)

#pydantic_extra_types.color.parse_hsl\(light\)

The lightness value.

**`alpha`** : [`float`](https://docs.python.org/3/library/functions.html#float) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic_extra_types.color.parse_hsl\(alpha\)

Alpha value.

## float_to_255 

#pydantic_extra_types.color.float_to_255
...
#pydantic_extra_types.color.float_to_255\(c\)
