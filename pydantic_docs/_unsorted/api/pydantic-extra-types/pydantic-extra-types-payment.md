...
The `pydantic_extra_types.payment` module provides the [`PaymentCardNumber`](#pydantic_extra_types.payment.PaymentCardNumber) data type.
...
#pydantic_extra_types.payment.PaymentCardNumber.strip_whitespace
...
#pydantic_extra_types.payment.PaymentCardNumber.min_length
...
#pydantic_extra_types.payment.PaymentCardNumber.max_length
...
#pydantic_extra_types.payment.PaymentCardNumber.bin
...
#pydantic_extra_types.payment.PaymentCardNumber.last4
...
#pydantic_extra_types.payment.PaymentCardNumber.brand
...
#pydantic_extra_types.payment.PaymentCardNumber.masked
...
#pydantic_extra_types.payment.PaymentCardNumber.validate
...
#pydantic_extra_types.payment.PaymentCardNumber.validate\(__input_value\)

The input value to validate.

**`_`** : `core_schema.ValidationInfo`

#pydantic_extra_types.payment.PaymentCardNumber.validate\(_\)

The validation info.

#### validate_digits 

#pydantic_extra_types.payment.PaymentCardNumber.validate_digits
...
#pydantic_extra_types.payment.PaymentCardNumber.validate_digits\(card_number\)
...
#pydantic_extra_types.payment.PaymentCardNumber.validate_luhn_check_digit
...
#pydantic_extra_types.payment.PaymentCardNumber.validate_luhn_check_digit\(card_number\)
...
#pydantic_extra_types.payment.PaymentCardNumber.validate_brand
...
#pydantic_extra_types.payment.PaymentCardNumber.validate_brand\(card_number\)
