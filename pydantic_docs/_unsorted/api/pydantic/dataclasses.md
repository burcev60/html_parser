...
#pydantic.dataclasses.dataclass\(_cls\)
...
#pydantic.dataclasses.dataclass\(init\)
...
#pydantic.dataclasses.dataclass\(repr\)
...
#pydantic.dataclasses.dataclass\(eq\)
...
#pydantic.dataclasses.dataclass\(order\)
...
#pydantic.dataclasses.dataclass\(unsafe_hash\)
...
#pydantic.dataclasses.dataclass\(frozen\)
...
#pydantic.dataclasses.dataclass\(config\)
...
#pydantic.dataclasses.dataclass\(validate_on_init\)
...
#pydantic.dataclasses.dataclass\(kw_only\)
...
#pydantic.dataclasses.dataclass\(slots\)
...
#pydantic.dataclasses.rebuild_dataclass\(force\)
...
#pydantic.dataclasses.rebuild_dataclass\(raise_errors\)
...
#pydantic.dataclasses.rebuild_dataclass\(_parent_namespace_depth\)

The depth level of the parent namespace, defaults to 2.

**`_types_namespace`** : `MappingNamespace` | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.dataclasses.rebuild_dataclass\(_types_namespace\)
...
#pydantic.dataclasses.is_pydantic_dataclass\(class_\)
