---
title: Experimental
source: https://pydantic.dev/docs/validation/latest/api/pydantic/experimental
---
...
#pydantic.experimental.pipeline._Pipeline.transform
...
#pydantic.experimental.pipeline._Pipeline.validate_as
...
#pydantic.experimental.pipeline._Pipeline.validate_as_deferred
...
#pydantic.experimental.pipeline._Pipeline.constrain
...
#pydantic.experimental.pipeline._Pipeline.predicate
...
#pydantic.experimental.pipeline._Pipeline.gt
...
#pydantic.experimental.pipeline._Pipeline.lt
...
#pydantic.experimental.pipeline._Pipeline.ge
...
#pydantic.experimental.pipeline._Pipeline.le
...
#pydantic.experimental.pipeline._Pipeline.len
...
#pydantic.experimental.pipeline._Pipeline.multiple_of
...
#pydantic.experimental.pipeline._Pipeline.eq
...
#pydantic.experimental.pipeline._Pipeline.not_eq
...
#pydantic.experimental.pipeline._Pipeline.in_
...
#pydantic.experimental.pipeline._Pipeline.otherwise
...
#pydantic.experimental.pipeline._Pipeline.then
...
#pydantic.experimental.arguments_schema.generate_arguments_schema\(func\)
...
#pydantic.experimental.arguments_schema.generate_arguments_schema\(schema_type\)
...
#pydantic.experimental.arguments_schema.generate_arguments_schema\(parameters_callback\)
...
#pydantic.experimental.arguments_schema.generate_arguments_schema\(config\)
