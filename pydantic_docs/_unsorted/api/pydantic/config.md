...
#pydantic.config.ConfigDict.title
...
#pydantic.config.ConfigDict.model_title_generator
...
#pydantic.config.ConfigDict.field_title_generator
...
#pydantic.config.ConfigDict.str_to_lower
...
#pydantic.config.ConfigDict.str_to_upper
...
#pydantic.config.ConfigDict.str_strip_whitespace
...
#pydantic.config.ConfigDict.str_min_length
...
#pydantic.config.ConfigDict.str_max_length
...
```
  ...
  * `'forbid'`: Providing extra data is not permitted, and a [`ValidationError`](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core/#pydantic_core.ValidationError) ([local](./../pydantic-core/pydantic-core.md#pydantic_core.ValidationError)) will be raised if this is the case:
...
#pydantic.config.ConfigDict.frozen
...
#pydantic.config.ConfigDict.populate_by_name
...
#pydantic.config.ConfigDict.use_enum_values
...
#pydantic.config.ConfigDict.validate_assignment
...
#pydantic.config.ConfigDict.arbitrary_types_allowed
...
#pydantic.config.ConfigDict.from_attributes
...
#pydantic.config.ConfigDict.loc_by_alias
...
#pydantic.config.ConfigDict.alias_generator
...
#pydantic.config.ConfigDict.ignored_types
...
#pydantic.config.ConfigDict.allow_inf_nan
...
#pydantic.config.ConfigDict.json_schema_extra
...
#pydantic.config.ConfigDict.json_encoders
...
#pydantic.config.ConfigDict.strict
...
See [Strict Mode](https://pydantic.dev/docs/validation/latest/concepts/strict_mode) ([local](./../../concepts/strict-mode.md)) for more details.

See the [Conversion Table](https://pydantic.dev/docs/validation/latest/concepts/conversion_table) ([local](./../../concepts/conversion-table.md)) for more details on how Pydantic converts data in both strict and lax modes.
...
#pydantic.config.ConfigDict.revalidate_instances
...
#pydantic.config.ConfigDict.ser_json_timedelta
...
It is now recommended to use the [`ser_json_temporal`](#pydantic.config.ConfigDict.ser_json_temporal) setting. `ser_json_timedelta` will be deprecated in v3.

**Type:** [`Literal`](https://docs.python.org/3/library/typing.html#typing.Literal)[‘iso8601’, ‘float’]

#### ser_json_temporal 

#pydantic.config.ConfigDict.ser_json_temporal
...
This setting replaces [`ser_json_timedelta`](#pydantic.config.ConfigDict.ser_json_timedelta), which will be deprecated in v3. `ser_json_temporal` adds more configurability for the other temporal types.

**Type:** [`Literal`](https://docs.python.org/3/library/typing.html#typing.Literal)[‘iso8601’, ‘seconds’, ‘milliseconds’]

#### val_temporal_unit 

#pydantic.config.ConfigDict.val_temporal_unit
...
#pydantic.config.ConfigDict.ser_json_bytes
...
#pydantic.config.ConfigDict.val_json_bytes
...
#pydantic.config.ConfigDict.ser_json_inf_nan
...
#pydantic.config.ConfigDict.validate_default
...
#pydantic.config.ConfigDict.validate_return
...
#pydantic.config.ConfigDict.hide_input_in_errors
...
#pydantic.config.ConfigDict.defer_build

Whether to defer model validator and serializer construction until the first model validation. Defaults to False.

This can be useful to avoid the overhead of building models which are only used nested within other models, or when you want to manually define type namespace via [`Model.model_rebuild(_types_namespace=...)`](https://pydantic.dev/docs/validation/latest/api/pydantic/base_model/#pydantic.BaseModel.model_rebuild) ([local](./base-model.md#pydantic.BaseModel.model_rebuild)).

↻ Changed in v2.10

The setting also applies to [Pydantic dataclasses](https://pydantic.dev/docs/validation/latest/concepts/dataclasses) ([local](./../../concepts/dataclasses.md)) and [type adapters](https://pydantic.dev/docs/validation/latest/concepts/type_adapter) ([local](./../../concepts/type-adapter.md)).
...
#pydantic.config.ConfigDict.schema_generator
...
#pydantic.config.ConfigDict.json_schema_serialization_defaults_required
...
#pydantic.config.ConfigDict.json_schema_mode_override
...
#pydantic.config.ConfigDict.coerce_numbers_to_str
...
#pydantic.config.ConfigDict.regex_engine
...
#pydantic.config.ConfigDict.validation_error_cause
...
#pydantic.config.ConfigDict.use_attribute_docstrings
...
#pydantic.config.ConfigDict.cache_strings
...
#pydantic.config.ConfigDict.validate_by_alias
...
See [usage errors](https://pydantic.dev/docs/validation/latest/errors/usage_errors#validate-by-alias-and-name-false) ([local](./../../errors/usage-errors.md#validate-by-alias-and-name-false)) for an example.
...
This setting was introduced in conjunction with [`validate_by_name`](#pydantic.config.ConfigDict.validate_by_name) to empower users with more fine grained validation control.
...
This setting was introduced in conjunction with [`validate_by_alias`](#pydantic.config.ConfigDict.validate_by_alias) to empower users with more fine grained validation control. It is an alternative to [`populate_by_name`](#pydantic.config.ConfigDict.populate_by_name), that enables validation by name **and** by alias.

**Type:** [`bool`](https://docs.python.org/3/library/functions.html#bool)

#### serialize_by_alias 

#pydantic.config.ConfigDict.serialize_by_alias
...
#pydantic.config.ConfigDict.url_preserve_empty_path
...
#pydantic.config.ConfigDict.polymorphic_serialization
...
#pydantic.alias_generators.to_pascal\(snake\)
...
#pydantic.alias_generators.to_camel\(snake\)
...
#pydantic.alias_generators.to_snake\(camel\)
