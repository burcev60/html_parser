...
#pydantic.functional_serializers.PlainSerializer.func
...
#pydantic.functional_serializers.PlainSerializer.return_type
...
#pydantic.functional_serializers.PlainSerializer.when_used
...
#pydantic.functional_serializers.WrapSerializer.func
...
#pydantic.functional_serializers.WrapSerializer.return_type
...
#pydantic.functional_serializers.WrapSerializer.when_used
...
#pydantic.functional_serializers.SerializeAsAny
...
#pydantic.functional_serializers.field_serializer\(*fields\)
...
#pydantic.functional_serializers.field_serializer\(mode\)
...
#pydantic.functional_serializers.field_serializer\(return_type\)
...
#pydantic.functional_serializers.field_serializer\(when_used\)
...
#pydantic.functional_serializers.field_serializer\(check_fields\)
...
#pydantic.functional_serializers.model_serializer\(f\)

The function to be decorated.

**`mode`** : [`Literal`](https://docs.python.org/3/library/typing.html#typing.Literal)[‘plain’, ‘wrap’] _Default:_ `'plain'`

#pydantic.functional_serializers.model_serializer\(mode\)
...
#pydantic.functional_serializers.model_serializer\(when_used\)

Determines when this serializer should be used.

**`return_type`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any) _Default:_ `PydanticUndefined`

#pydantic.functional_serializers.model_serializer\(return_type\)

The return type for the function. If omitted it will be inferred from the type annotation.

## FieldPlainSerializer 

#pydantic.functional_serializers.FieldPlainSerializer
...
#pydantic.functional_serializers.FieldWrapSerializer
...
#pydantic.functional_serializers.FieldSerializer
...
#pydantic.functional_serializers.ModelPlainSerializerWithInfo
...
#pydantic.functional_serializers.ModelWrapSerializerWithInfo
...
#pydantic.functional_serializers.ModelWrapSerializerWithoutInfo
...
#pydantic.functional_serializers.ModelWrapSerializer
