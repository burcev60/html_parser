...
[`TypeAdapter`](https://pydantic.dev/docs/validation/latest/concepts/type_adapter) ([local](./../../concepts/type-adapter.md))
...
#pydantic.type_adapter.TypeAdapter.__init__\(type\)
...
#pydantic.type_adapter.TypeAdapter.__init__\(config\)
...
#pydantic.type_adapter.TypeAdapter.__init__\(module\)
...
#pydantic.type_adapter.TypeAdapter.core_schema
...
#pydantic.type_adapter.TypeAdapter.validator
...
#pydantic.type_adapter.TypeAdapter.serializer
...
#pydantic.type_adapter.TypeAdapter.pydantic_complete
...
#pydantic.type_adapter.TypeAdapter.rebuild
...
#pydantic.type_adapter.TypeAdapter.rebuild\(force\)
...
#pydantic.type_adapter.TypeAdapter.rebuild\(raise_errors\)
...
#pydantic.type_adapter.TypeAdapter.rebuild\(_parent_namespace_depth\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(object\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(strict\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(extra\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(from_attributes\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(context\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(experimental_allow_partial\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(by_alias\)
...
#pydantic.type_adapter.TypeAdapter.validate_python\(by_name\)
...
#pydantic.type_adapter.TypeAdapter.validate_json\(data\)

The JSON data to validate against the model.

**`strict`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_json\(strict\)

Whether to strictly check types.

**`extra`** : `ExtraValues` | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_json\(extra\)

Whether to ignore, allow, or forbid extra data during model validation. See the [`extra` configuration value](https://pydantic.dev/docs/validation/latest/api/pydantic/config/#pydantic.config.ConfigDict.extra) ([local](./config.md#pydantic.config.ConfigDict.extra)) for details.

**`context`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_json\(context\)

Additional context to use during validation.

**`experimental_allow_partial`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`Literal`](https://docs.python.org/3/library/typing.html#typing.Literal)[‘off’, ‘on’, ‘trailing-strings’] _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.validate_json\(experimental_allow_partial\)
...
#pydantic.type_adapter.TypeAdapter.validate_json\(by_alias\)

Whether to use the field’s alias when validating against the provided input data.

**`by_name`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_json\(by_name\)

Whether to use the field’s name when validating against the provided input data.

#### validate_strings 

#pydantic.type_adapter.TypeAdapter.validate_strings
...
#pydantic.type_adapter.TypeAdapter.validate_strings\(obj\)

The object contains string data to validate.

**`strict`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_strings\(strict\)

Whether to strictly check types.

**`extra`** : `ExtraValues` | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_strings\(extra\)

Whether to ignore, allow, or forbid extra data during model validation. See the [`extra` configuration value](https://pydantic.dev/docs/validation/latest/api/pydantic/config/#pydantic.config.ConfigDict.extra) ([local](./config.md#pydantic.config.ConfigDict.extra)) for details.

**`context`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_strings\(context\)

Additional context to use during validation.

**`experimental_allow_partial`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`Literal`](https://docs.python.org/3/library/typing.html#typing.Literal)[‘off’, ‘on’, ‘trailing-strings’] _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.validate_strings\(experimental_allow_partial\)
...
#pydantic.type_adapter.TypeAdapter.validate_strings\(by_alias\)

Whether to use the field’s alias when validating against the provided input data.

**`by_name`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.validate_strings\(by_name\)

Whether to use the field’s name when validating against the provided input data.

#### get_default_value 

#pydantic.type_adapter.TypeAdapter.get_default_value
...
#pydantic.type_adapter.TypeAdapter.get_default_value\(strict\)

Whether to strictly check types.

**`context`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.get_default_value\(context\)

Additional context to pass to the validator.

#### dump_python 

#pydantic.type_adapter.TypeAdapter.dump_python
...
#pydantic.type_adapter.TypeAdapter.dump_python\(exclude_unset\)
...
#pydantic.type_adapter.TypeAdapter.dump_python\(exclude_defaults\)
...
#pydantic.type_adapter.TypeAdapter.dump_python\(exclude_none\)
...
#pydantic.type_adapter.TypeAdapter.dump_python\(exclude_computed_fields\)
...
#pydantic.type_adapter.TypeAdapter.dump_python\(round_trip\)
...
#pydantic.type_adapter.TypeAdapter.dump_python\(warnings\)

How to handle serialization errors. False/“none” ignores them, True/“warn” logs errors, “error” raises a [`PydanticSerializationError`](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core/#pydantic_core.PydanticSerializationError) ([local](./../pydantic-core/pydantic-core.md#pydantic_core.PydanticSerializationError)).
...
#pydantic.type_adapter.TypeAdapter.dump_python\(fallback\)

A function to call when an unknown value is encountered. If not provided, a [`PydanticSerializationError`](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core/#pydantic_core.PydanticSerializationError) ([local](./../pydantic-core/pydantic-core.md#pydantic_core.PydanticSerializationError)) error is raised.

**`serialize_as_any`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_python\(serialize_as_any\)
...
#pydantic.type_adapter.TypeAdapter.dump_python\(polymorphic_serialization\)

Whether to use model and dataclass polymorphic serialization for this call.

**`context`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.dump_python\(context\)
...
#pydantic.type_adapter.TypeAdapter.dump_json\(instance\)
...
#pydantic.type_adapter.TypeAdapter.dump_json\(indent\)

Number of spaces for JSON indentation.

**`ensure_ascii`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_json\(ensure_ascii\)
...
#pydantic.type_adapter.TypeAdapter.dump_json\(include\)

Fields to include.

**`exclude`** : `IncEx` | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.dump_json\(exclude\)

Fields to exclude.

**`by_alias`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.dump_json\(by_alias\)

Whether to use alias names for field names.

**`exclude_unset`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_json\(exclude_unset\)

Whether to exclude unset fields.

**`exclude_defaults`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_json\(exclude_defaults\)

Whether to exclude fields with default values.

**`exclude_none`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_json\(exclude_none\)

Whether to exclude fields with a value of `None`.

**`exclude_computed_fields`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_json\(exclude_computed_fields\)

Whether to exclude computed fields. While this can be useful for round-tripping, it is usually recommended to use the dedicated `round_trip` parameter instead.

**`round_trip`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_json\(round_trip\)

Whether to serialize and deserialize the instance to ensure round-tripping.

**`warnings`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`Literal`](https://docs.python.org/3/library/typing.html#typing.Literal)[‘none’, ‘warn’, ‘error’] _Default:_ `True`

#pydantic.type_adapter.TypeAdapter.dump_json\(warnings\)

How to handle serialization errors. False/“none” ignores them, True/“warn” logs errors, “error” raises a [`PydanticSerializationError`](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core/#pydantic_core.PydanticSerializationError) ([local](./../pydantic-core/pydantic-core.md#pydantic_core.PydanticSerializationError)).

**`fallback`** : [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`Any`](https://docs.python.org/3/library/typing.html#typing.Any)], [`Any`](https://docs.python.org/3/library/typing.html#typing.Any)] | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.dump_json\(fallback\)

A function to call when an unknown value is encountered. If not provided, a [`PydanticSerializationError`](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core/#pydantic_core.PydanticSerializationError) ([local](./../pydantic-core/pydantic-core.md#pydantic_core.PydanticSerializationError)) error is raised.

**`serialize_as_any`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) _Default:_ `False`

#pydantic.type_adapter.TypeAdapter.dump_json\(serialize_as_any\)

Whether to serialize fields with duck-typing serialization behavior.

**`polymorphic_serialization`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.dump_json\(polymorphic_serialization\)

Whether to use model and dataclass polymorphic serialization for this call.

**`context`** : [`Any`](https://docs.python.org/3/library/typing.html#typing.Any) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.type_adapter.TypeAdapter.dump_json\(context\)

Additional context to pass to the serializer.

#### json_schema 

#pydantic.type_adapter.TypeAdapter.json_schema
...
#pydantic.type_adapter.TypeAdapter.json_schema\(by_alias\)

Whether to use alias names for field names.

**`ref_template`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str) _Default:_ `DEFAULT_REF_TEMPLATE`

#pydantic.type_adapter.TypeAdapter.json_schema\(ref_template\)
...
#pydantic.type_adapter.TypeAdapter.json_schema\(union_format\)
...
#pydantic.type_adapter.TypeAdapter.json_schema\(schema_generator\)
...
#pydantic.type_adapter.TypeAdapter.json_schema\(mode\)
...
#pydantic.type_adapter.TypeAdapter.json_schemas
...
**`inputs`** : [`Iterable`](https://docs.python.org/3/library/typing.html#typing.Iterable)[[`tuple`](https://docs.python.org/3/library/stdtypes.html#tuple)[`JsonSchemaKeyT`, `JsonSchemaMode`, [`TypeAdapter`](#pydantic.type_adapter.TypeAdapter)[[`Any`](https://docs.python.org/3/library/typing.html#typing.Any)]]] 

#pydantic.type_adapter.TypeAdapter.json_schemas\(inputs\)
...
#pydantic.type_adapter.TypeAdapter.json_schemas\(by_alias\)
...
#pydantic.type_adapter.TypeAdapter.json_schemas\(title\)
...
#pydantic.type_adapter.TypeAdapter.json_schemas\(description\)

The description for the schema.

**`ref_template`** : [`str`](https://docs.python.org/3/library/stdtypes.html#str) _Default:_ `DEFAULT_REF_TEMPLATE`

#pydantic.type_adapter.TypeAdapter.json_schemas\(ref_template\)

The format string used for generating $ref strings.

**`union_format`** : [`Literal`](https://docs.python.org/3/library/typing.html#typing.Literal)[‘any_of’, ‘primitive_type_array’] _Default:_ `'any_of'`

#pydantic.type_adapter.TypeAdapter.json_schemas\(union_format\)
...
#pydantic.type_adapter.TypeAdapter.json_schemas\(schema_generator\)
