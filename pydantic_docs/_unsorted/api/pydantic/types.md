...
[Strict Mode with `Annotated` `Strict`](https://pydantic.dev/docs/validation/latest/concepts/strict_mode#strict-mode-with-annotated-strict) ([local](./../../concepts/strict-mode.md#strict-mode-with-annotated-strict))
...
#pydantic.types.AllowInfNan.allow_inf_nan
...
[String types](https://pydantic.dev/docs/validation/latest/api/pydantic/standard_library_types#strings) ([local](./standard-library-types.md#strings))
...
#pydantic.types.StringConstraints.strip_whitespace
...
#pydantic.types.StringConstraints.to_upper
...
#pydantic.types.StringConstraints.to_lower
...
#pydantic.types.StringConstraints.strict
...
#pydantic.types.StringConstraints.min_length
...
#pydantic.types.StringConstraints.max_length
...
#pydantic.types.StringConstraints.pattern
...
#pydantic.types.StringConstraints.ascii_only
...
#pydantic.types.UuidVersion.uuid_version
...
As seen above, by default, [`SecretStr`](#pydantic.types.SecretStr) (and [`SecretBytes`](#pydantic.types.SecretBytes)) will be serialized as `**********` when serializing to json.

You can use the [`field_serializer`](https://pydantic.dev/docs/validation/latest/api/pydantic/functional_serializers/#pydantic.functional_serializers.field_serializer) ([local](./functional-serializers.md#pydantic.functional_serializers.field_serializer)) to dump the secret as plain-text when serializing to json.
...
#pydantic.types.PaymentCardNumber.validate
...
[`PaymentCardNumber`](#pydantic.types.PaymentCardNumber)
...
#pydantic.types.PaymentCardNumber.validate_brand
...
#pydantic.types.ByteSize.human_readable\(decimal\)
...
#pydantic.types.ByteSize.human_readable\(separator\)
...
#pydantic.types.ByteSize.to\(unit\)
...
#pydantic.types.EncoderProtocol.decode\(data\)
...
#pydantic.types.EncoderProtocol.encode\(value\)
...
**Bases:** [`EncoderProtocol`](#pydantic.types.EncoderProtocol)
...
#pydantic.types.Base64Encoder.decode
...
#pydantic.types.Base64Encoder.decode\(data\)

The data to decode.

#### encode 

#pydantic.types.Base64Encoder.encode
...
#pydantic.types.Base64Encoder.encode\(value\)

The data to encode.

#### get_json_format 

#pydantic.types.Base64Encoder.get_json_format
...
#pydantic.types.Base64UrlEncoder.decode
...
#pydantic.types.Base64UrlEncoder.decode\(data\)

The data to decode.

#### encode 

#pydantic.types.Base64UrlEncoder.encode
...
#pydantic.types.Base64UrlEncoder.encode\(value\)

The data to encode.

#### get_json_format 

#pydantic.types.Base64UrlEncoder.get_json_format
...
#pydantic.types.EncodedBytes.decode
...
#pydantic.types.EncodedBytes.decode\(data\)

The data to decode.

#### encode 

#pydantic.types.EncodedBytes.encode
...
#pydantic.types.EncodedBytes.encode\(value\)
...
#pydantic.types.EncodedStr.decode_str
...
#pydantic.types.EncodedStr.decode_str\(data\)

The data to decode.

#### encode_str 

#pydantic.types.EncodedStr.encode_str
...
#pydantic.types.EncodedStr.encode_str\(value\)
...
#pydantic.types.Discriminator.discriminator
...
#pydantic.types.Discriminator.custom_error_type
...
#pydantic.types.Discriminator.custom_error_message
...
#pydantic.types.Discriminator.custom_error_context
...
The reason is that `conint` returns a type, which doesn’t play well with static analysis tools.
  ...
  * [ :x: Don't do this ](#tab-panel-695)
  * [ :white_check_mark: Do this ](#tab-panel-696)
...
#pydantic.types.conint\(multiple_of\)
...
The reason is that `confloat` returns a type, which doesn’t play well with static analysis tools.
  ...
  * [ :x: Don't do this ](#tab-panel-697)
  * [ :white_check_mark: Do this ](#tab-panel-698)
...
#pydantic.types.confloat\(strict\)
...
#pydantic.types.confloat\(multiple_of\)
...
#pydantic.types.confloat\(allow_inf_nan\)
...
#pydantic.types.conbytes\(min_length\)
...
#pydantic.types.conbytes\(max_length\)

The maximum length of the bytes.

**`strict`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.conbytes\(strict\)
...
This function is **discouraged** in favor of using [`Annotated`](https://docs.python.org/3/library/typing.html#typing.Annotated) with [`StringConstraints`](#pydantic.types.StringConstraints) instead.

This function will be **deprecated** in Pydantic 3.0.

The reason is that `constr` returns a type, which doesn’t play well with static analysis tools.

  * [ :x: Don't do this ](#tab-panel-699)
  * [ :white_check_mark: Do this ](#tab-panel-700)
...
#pydantic.types.constr\(strip_whitespace\)
...
#pydantic.types.constr\(to_upper\)
...
#pydantic.types.constr\(to_lower\)

Whether to turn all characters to lowercase.

**`strict`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.constr\(strict\)

Whether to validate the string in strict mode.

**`min_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.constr\(min_length\)

The minimum length of the string.

**`max_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.constr\(max_length\)
...
#pydantic.types.constr\(ascii_only\)
...
#pydantic.types.conset\(item_type\)

The type of the items in the set.

**`min_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.conset\(min_length\)

The minimum length of the set.

**`max_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.conset\(max_length\)

The maximum length of the set.

## confrozenset 

#pydantic.types.confrozenset
...
#pydantic.types.confrozenset\(item_type\)

The type of the items in the frozenset.

**`min_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.confrozenset\(min_length\)

The minimum length of the frozenset.

**`max_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.confrozenset\(max_length\)
...
#pydantic.types.conlist\(item_type\)

The type of the items in the list.

**`min_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.conlist\(min_length\)

The minimum length of the list. Defaults to None.

**`max_length`** : [`int`](https://docs.python.org/3/library/functions.html#int) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.conlist\(max_length\)
...
#pydantic.types.conlist\(unique_items\)
...
The reason is that `condecimal` returns a type, which doesn’t play well with static analysis tools.
  ...
  * [ :x: Don't do this ](#tab-panel-701)
  * [ :white_check_mark: Do this ](#tab-panel-702)
...
#pydantic.types.condecimal\(strict\)
...
#pydantic.types.condecimal\(multiple_of\)
...
#pydantic.types.condecimal\(max_digits\)
...
#pydantic.types.condecimal\(decimal_places\)

The number of decimal places. Defaults to `None`.

**`allow_inf_nan`** : [`bool`](https://docs.python.org/3/library/functions.html#bool) | [`None`](https://docs.python.org/3/library/constants.html#None) _Default:_ `None`

#pydantic.types.condecimal\(allow_inf_nan\)
...
#pydantic.types.NonPositiveFloat
...
#pydantic.types.NonNegativeFloat
...
These methods are considered legacy implementation. See the documentation about the [`Base64Bytes`](#pydantic.types.Base64Bytes) type for more information on how to replicate the old behavior with the legacy encoders/decoders.
...
#pydantic.types.OnErrorOmit

When used as an item in a list, the key type in a dict, optional values of a TypedDict, etc. this annotation omits the item from the iteration if there is any error validating it. That is, instead of a [`ValidationError`](https://pydantic.dev/docs/validation/latest/api/pydantic-core/pydantic_core/#pydantic_core.ValidationError) ([local](./../pydantic-core/pydantic-core.md#pydantic_core.ValidationError)) being propagated up and the entire iterable being discarded any invalid items are discarded and the valid ones are returned.
