...
The “Strict” column contains checkmarks for type conversions that are allowed when validating in [Strict Mode](https://pydantic.dev/docs/validation/latest/concepts/strict_mode) ([local](./strict-mode.md)).

  * [ All ](#tab-panel-529)
  * [ JSON ](#tab-panel-530)
  * [ JSON - Strict ](#tab-panel-531)
  * [ Python ](#tab-panel-532)
  * [ Python - Strict ](#tab-panel-533)
