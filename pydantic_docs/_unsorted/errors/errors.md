...
Pydantic attempts to provide useful default error messages for validation and usage errors, which can be found here:
  ...
  * [Validation Errors](https://pydantic.dev/docs/validation/latest/errors/validation_errors) ([local](./validation-errors.md)): Errors that happen during data validation.
  * [Usage Errors](https://pydantic.dev/docs/validation/latest/errors/usage_errors) ([local](./usage-errors.md)): Errors that happen when using Pydantic.
